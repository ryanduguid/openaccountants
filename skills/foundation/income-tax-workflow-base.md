...
description: >
  Tier 1 workflow base for international income tax skills. Adapts the execution pipeline, conservative defaults principle, output spec, and self-check framework from us-tax-workflow-base for non-US jurisdictions. Provides the universal runbook that all international income tax content skills load on top of.
version: 0.1
jurisdiction: GLOBAL
tax_year: 2025
category: foundation
...
# International Income Tax Workflow Base v0.1
...
- **Forms:** All international income tax returns
...
[To be completed. Cite primary sources: National income tax legislation]
