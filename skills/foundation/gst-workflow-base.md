---
name: gst-workflow-base
description: >
  Tier 1 workflow base for GST/HST systems (Canada, Australia, India, NZ, Singapore). Defines the execution pipeline, output spec, self-checks, and refusal catalogue for Goods and Services Tax returns. Parallel to vat-workflow-base but adapted for GST registration thresholds, input tax credit rules, and return structures.
version: 0.1
jurisdiction: GLOBAL
tax_year: 2025
category: foundation
...
- **Forms:** GST/HST returns globally
...
[To be completed. Cite primary sources: National GST/HST legislation]
