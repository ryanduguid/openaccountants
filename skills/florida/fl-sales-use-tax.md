...
description: >
  Florida Sales and Use Tax return (Form DR-15) for self-employed individuals and small businesses. Covers taxable sales, discretionary sales surtax, use tax, and filing frequencies.
version: 0.1
jurisdiction: US-FL
tax_year: 2025
category: state
...
# Florida Sales and Use Tax v0.1
...
[To be completed. Cite primary sources: Florida Statutes Ch. 212]
