...
description: >
  Florida Annual Report filing for LLCs registered with the Division of Corporations (Sunbiz). Covers the annual report requirement, fee schedule, filing deadline, and late filing penalties.
version: 0.1
jurisdiction: US-FL
tax_year: 2025
category: state
...
[To be completed. Cite primary sources: Florida Statutes §605.0212]
