...
- **Suppression rule** — If estimated savings fall below the floor, suppress the suggestion unless the user explicitly asks "show me everything."

## Section 5 -- Output format

### Part A -- Savings summary

**Part A -- Savings summary example table**
...
- **Priority definitions** — Priority: HIGH (> 5x materiality floor), MEDIUM (2-5x floor), LOW (1-2x floor).
