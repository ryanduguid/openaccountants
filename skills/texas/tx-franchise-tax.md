...
description: >
  Texas Franchise Tax (Form 05-102) for single-member LLCs. Covers the no-tax-due threshold, EZ computation rate, Public Information Report, and annual filing requirements under Texas Tax Code Ch. 171.
version: 0.1
jurisdiction: US-TX
tax_year: 2025
category: state
...
[To be completed. Cite primary sources: Texas Tax Code Ch. 171]
