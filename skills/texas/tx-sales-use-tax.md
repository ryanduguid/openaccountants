...
description: >
  Texas Sales and Use Tax return (Form 01-114) for self-employed individuals and small businesses. Covers taxable sales, use tax on out-of-state purchases, data processing services exemption under §151.351, and filing frequencies.
version: 0.1
jurisdiction: US-TX
tax_year: 2025
category: state
...
[To be completed. Cite primary sources: Texas Tax Code Ch. 151]
