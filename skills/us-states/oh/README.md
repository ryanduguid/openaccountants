# Ohio — OpenAccountants Tax Skills
...
| Code | US-OH |
| Income tax | Yes |
| Sales tax | Yes (5.75% state rate + local) |
| Franchise / gross receipts tax | Yes — Commercial Activity Tax (CAT) |
...
- Corporate franchise tax (repealed, replaced by CAT)
- Estate / inheritance tax (Ohio repealed its estate tax effective 2013)
