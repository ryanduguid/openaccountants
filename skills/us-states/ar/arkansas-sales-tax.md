...
- **Grocery food is not exempt** — NEVER say grocery food is exempt -- it is taxed at 0.125% state plus full local.  _(Section 10 -- Prohibitions)_
- **SST certificates accepted** — NEVER forget SST certificates are accepted.  _(Section 10 -- Prohibitions)_
- **Never compute numbers** — NEVER compute any number.  _(Section 10 -- Prohibitions)_
