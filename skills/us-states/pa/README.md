# Pennsylvania — OpenAccountants Tax Skills

| Field | Value |
|---|---|
| State | Pennsylvania |
| Code | US-PA |
| Income tax | Yes (flat 3.07%) |
| Sales tax | Yes (6% state + up to 2% local) |
...
- Capital stock / franchise tax (repealed 2016)
- Inheritance tax (PA has an inheritance tax, not an estate tax)
- Pass-through business election (PTE election)
