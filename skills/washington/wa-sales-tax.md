...
name: wa-sales-tax
description: >
  Washington State Sales Tax for self-employed individuals selling taxable goods or services. Covers state + local tax rates, destination-based sourcing, and use tax.
version: 0.1
jurisdiction: US-WA
tax_year: 2025
category: state
...
[To be completed. Cite primary sources: RCW 82.08]
