...
description: >
  Washington State Business and Occupation Tax for self-employed individuals. Covers gross receipts tax classifications (service, retailing, wholesaling), B&O tax rates, small business credit, and filing frequencies.
version: 0.1
jurisdiction: US-WA
tax_year: 2025
category: state
...
# Washington B&O Tax v0.1

## What this file is

**Obligation category:** IT (Income Tax — gross receipts)
...
- **Forms:** Combined Excise Tax Return
...
[To be completed. Cite primary sources: RCW 82.04]
