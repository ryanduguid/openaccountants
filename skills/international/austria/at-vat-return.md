...
name: at-vat-return
description: >
  Austrian VAT return (Umsatzsteuervoranmeldung / UVA) for self-employed individuals. Covers standard (20%), reduced (10%/13%) rates, Kleinunternehmerregelung (€35K threshold), and monthly/quarterly filing.
version: 0.1
jurisdiction: AT
tax_year: 2025
...
[To be completed. Cite primary sources: UStG (Austria), EU VAT Directive]
