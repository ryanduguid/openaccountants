...
name: gr-income-tax
description: >
  Greek income tax (Φορολογική Δήλωση E1) for self-employed individuals. Covers progressive brackets (9–44%), solidarity surcharge (phased out check), professional expense presumptions, and e-filing via TAXISnet.
version: 0.1
jurisdiction: GR
tax_year: 2025
...
[To be completed. Cite primary sources: Κώδικας Φορολογίας Εισοδήματος (ΚΦΕ) N.4172/2013]
