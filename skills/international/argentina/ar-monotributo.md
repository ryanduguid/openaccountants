...
name: ar-monotributo
description: >
  Argentine Monotributo simplified tax regime for small self-employed individuals. Covers the unified monthly payment (impuesto integrado + aportes jubilatorios + obra social), category thresholds by revenue, and exclusion rules.
version: 0.1
jurisdiction: AR
tax_year: 2025
...
# Argentina Monotributo v0.1

## What this file is

**Obligation category:** IT+CT+SC
...
[To be completed. Cite primary sources: Ley 24.977 (Monotributo)]
