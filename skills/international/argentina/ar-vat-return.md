...
name: ar-vat-return
description: >
  Argentine VAT return (IVA) for self-employed individuals under the régimen general. Covers standard rate (21%), reduced (10.5%), increased (27%), monthly filing, and débito/crédito fiscal computation.
version: 0.1
jurisdiction: AR
tax_year: 2025
...
[To be completed. Cite primary sources: Ley 23.349]
