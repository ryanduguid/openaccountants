---
name: Djibouti Tax Overview
description: "Source-cited draft: tax overview for Djibouti (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: DJ
domain: income-tax
role: reference
tax_year: 2025
...
- **Minimum lump-sum tax (impot minimum forfaitaire)** — 1% of turnover excluding VAT, with a floor of DJF 120,000 ((approx — confirm))  _([Code General des Impots (Djibouti) — impot minimum forfaitaire](https://www.lawgratis.com/blog-detail/tax-laws-djibouti))_
- **Main annual corporate filing deadline** — 31 March of the year following the tax year ((approx — confirm))  _([Code General des Impots (Djibouti)](https://rivermate.com/guides/djibouti/taxes))_
