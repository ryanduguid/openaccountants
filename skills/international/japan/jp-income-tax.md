...
name: jp-income-tax
description: >
  Japanese income tax return (確定申告 Kakutei Shinkoku) for self-employed individuals. Covers business income (事業所得), blue return (青色申告) vs white return, progressive brackets (5–45%), resident tax, and special deductions.
version: 0.1
jurisdiction: JP
tax_year: 2025
...
[To be completed. Cite primary sources: 所得税法 (Income Tax Act)]
