...
description: >
  Japanese National Health Insurance (国民健康保険) and National Pension (国民年金) for self-employed individuals. Covers NHI calculation (income-based + per-capita), National Pension fixed monthly amount, and payment schedules.
version: 0.1
jurisdiction: JP
tax_year: 2025
...
# Japan NHI + National Pension v0.1
...
[To be completed. Cite primary sources: 国民健康保険法, 国民年金法]
