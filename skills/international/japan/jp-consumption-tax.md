...
description: >
  Japanese Consumption Tax return (消費税) for self-employed individuals. Covers standard rate (10%), reduced rate (8% for food/newspapers), qualified invoice system (インボイス制度), simplified taxation, and registration threshold (¥10M).
version: 0.1
jurisdiction: JP
tax_year: 2025
...
# Japan Consumption Tax (消費税) v0.1
...
[To be completed. Cite primary sources: 消費税法 (Consumption Tax Act)]
