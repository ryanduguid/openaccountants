...
description: >
  Japanese estimated tax prepayments (予定納税 Yotei Nōzei) for self-employed individuals. Covers the ¥150K threshold, two instalments (Jul/Nov), and reduction application.
version: 0.1
jurisdiction: JP
tax_year: 2025
...
[To be completed. Cite primary sources: 所得税法 s.104–106]
