...
description: >
  UK Student Loan repayment through Self Assessment for self-employed individuals. Covers Plan 1, Plan 2, Plan 4, Plan 5, and Postgraduate Loan thresholds and rates.
version: 0.1
jurisdiction: GB
tax_year: 2025
...
# UK Student Loan Repayment v0.1
...
- **Forms:** SA100 (Student Loan section)
...
[To be completed. Cite primary sources: Education (Student Loans) Act 1998]
