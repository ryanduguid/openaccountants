...
description: >
  UK Payments on Account for self-employed individuals. Covers the two payment dates (31 Jan, 31 Jul), balancing payment, claim to reduce, and interaction with tax codes.
version: 0.1
jurisdiction: GB
tax_year: 2025
...
[To be completed. Cite primary sources: TMA 1970 s59A]
