...
- **RS** social contributions are entirely employee-borne (~**32.8%**); **FBiH** splits employee/employer and the employer rate was cut to 5% from **1 Jul 2025** (combined 41.5% → 36%) — see `bosnia-payroll.md`.
...
- NEVER contradict the rates in `bosnia-income-tax.md` / `bosnia-social-contributions.md` / `bosnia-payroll.md` (RS employee total 32.8%; FBiH 1 Jul 2025 reform).
