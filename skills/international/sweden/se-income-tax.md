...
name: se-income-tax
description: >
  Swedish income tax return (Inkomstdeklaration 1) for self-employed (enskild firma). Covers kommunalskatt (~32%), statlig skatt (20% above SEK ~598K), jobbskatteavdrag, and NE-bilaga.
version: 0.1
jurisdiction: SE
tax_year: 2025
...
- **Forms:** Inkomstdeklaration 1, NE-bilaga
...
[To be completed. Cite primary sources: IL (Inkomstskattelag)]
