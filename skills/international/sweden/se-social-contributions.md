...
description: >
  Swedish self-employed social contributions (egenavgifter). Covers the ~28.97% rate on assessed income, reduction for first 5 years, and components (pension, health, parental).
version: 0.1
jurisdiction: SE
tax_year: 2025
...
# Sweden Social Contributions (Egenavgifter) v0.1
...
[To be completed. Cite primary sources: SAL (Socialavgiftslagen)]
