...
name: se-vat-return
description: >
  Swedish VAT return (Skattedeklaration, moms) for self-employed individuals. Covers standard (25%), reduced (12%/6%) rates, monthly/quarterly filing via Skatteverket.
version: 0.1
jurisdiction: SE
tax_year: 2025
...
[To be completed. Cite primary sources: ML (Mervärdesskattelagen), EU VAT Directive]
