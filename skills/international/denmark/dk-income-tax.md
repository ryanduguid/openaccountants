...
- **Minimum viable** — bank statement for the full tax year, municipality of residence, business form (selvstaendig erhvervsdrivende). (Minimum viable)
- **Recommended** — all invoices, prior year arsopgorelse, tax scheme election (VSO/KAO/none), Folkekirken membership status. (Recommended)
- **Ideal** — complete regnskab (accounts), asset register, B-skat payment records, VSO indskudskonto and opsparingskonto balances. (Ideal)
...
- **AM-bidrag rule** — 8% on gross personal income. Calculated FIRST, before all other deductions and taxes. Reduces base for bundskat, topskat, kommuneskat.
...
- **Personfradrag** — DKK 51,600. Provides tax value = personfradrag x (bundskat + kommuneskat + kirkeskat rates). Applied as credit.

### 5.5 Driftsomkostninger (Business Expenses)

- **Driftsomkostninger** — Deductible if incurred to acquire, secure, or maintain income (SL ss 6). Mixed-use must be apportioned.  _(SL ss 6)_
...
- **B-skat** — 10 monthly instalments (Jan-May, Aug-Dec). Self-assessed expected income. Adjustable via TastSelv. Underpayment above DKK 22,900 attracts interest.
...
- **VSO vs KAO vs Default election** — Must model all scenarios. VSO advantageous when significant business interest expenses or variable income. KAO when significant assets. Flag for reviewer.

### 6.2 VSO -- Opsparet Overskud

- **VSO Opsparet Overskud** — Retained profits taxed at 22% interim. Withdrawals taxed as personal income (22% credited). Complete separation of business/private required.

### 6.3 Home Office

- **Dedicated room, exclusively business** — proportional actual costs
- **Standard deduction** — 2,100 DKK/year (2025, alternative to actual costs)
- **Room suitability** — Room must be unsuitable for private use. Flag for reviewer.

### 6.4 Vehicle Business Use

- **Standard rate (first 20,000 km)** — 3.79 DKK/km
- **Standard rate (thereafter)** — 2.23 DKK/km
- **Actual costs alternative** — Or actual costs with logbook. Flag for reviewer.
...
- **Personfradrag transfer** — Unused personfradrag transferable between spouses for bundskat only (not topskat). Flag for reviewer.
