...
name: dk-vat-return
description: >
  Danish VAT return (Momsangivelse) for self-employed individuals. Covers standard (25%) rate (no reduced rate), quarterly filing, and registration threshold DKK 50K.
version: 0.1
jurisdiction: DK
tax_year: 2025
...
[To be completed. Cite primary sources: Momsloven, EU VAT Directive]
