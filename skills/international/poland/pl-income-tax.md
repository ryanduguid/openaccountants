...
name: pl-income-tax
description: >
  Polish income tax return (PIT-36) for self-employed individuals. Covers skala podatkowa (12%/32%), flat tax option (PIT-36L, 19%), IP Box (5%), ryczałt option, and kwota wolna.
version: 0.1
jurisdiction: PL
tax_year: 2025
...
[To be completed. Cite primary sources: Ustawa o PIT]
