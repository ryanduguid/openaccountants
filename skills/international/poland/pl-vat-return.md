...
name: pl-vat-return
description: >
  Polish VAT return (JPK_V7M/JPK_V7K) for self-employed individuals. Covers standard (23%), reduced (8%/5%/0%) rates, mandatory SAF-T (JPK) filing, split payment mechanism, and white list verification.
version: 0.1
jurisdiction: PL
tax_year: 2025
...
[To be completed. Cite primary sources: Ustawa o VAT, EU VAT Directive]
