...
description: >
  Dutch self-employed deductions (zelfstandigenaftrek, startersaftrek, MKB-winstvrijstelling) and the 1,225-hour requirement (urencriterium). Covers all zzp-specific tax benefits and phase-outs.
version: 0.1
jurisdiction: NL
tax_year: 2025
...
# Netherlands ZZP Deductions v0.1
...
- **Forms:** Aangifte IB (winst section)
...
[To be completed. Cite primary sources: Wet IB 2001 art. 3.76]
