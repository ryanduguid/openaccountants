---
name: Liechtenstein Personal Income Tax
description: "Source-cited draft: personal income tax for Liechtenstein (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: LI
domain: income-tax
role: compute
tax_year: 2025
...
- **National income tax rate range (before communal surcharge)** — 1% to 8% progressive %  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **Combined effective rate range (national + communal surcharge)** — 2.5% to 22.4% %  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **Communal surcharge (Gemeindesteuerzuschlag)** — 150% to 180% of national tax, fixed annually by each municipality %  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **1% national bracket threshold (single)** — Up to CHF 21,140 of taxable income CHF (approx — confirm 2025 figure)  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **8% (top) national bracket threshold (single)** — Taxable income above CHF 211,401 CHF (approx — confirm 2025 figure)  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **Tax-free personal exemption (single)** — CHF 15,855 CHF (approx — confirm 2025 figure)  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **Tax-free personal exemption (married, joint)** — CHF 31,710 CHF (approx — confirm 2025 figure)  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
- **Tax-free personal exemption (single parent)** — CHF 23,783 CHF (approx — confirm 2025 figure)  _(Tax Act (Steuergesetz, SteG) — https://taxsummaries.pwc.com/liechtenstein/individual/taxes-on-personal-income)_
