---
name: sr-vat-gst
description: "Source-cited draft: vat / gst for Suriname (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: SR
tax_year: 2025
...
Suriname introduced VAT (Belasting over de Toegevoegde Waarde, BTW) on 1 January 2023, replacing the former turnover tax. The standard rate is **10% on goods and services alike**, with reduced and higher rates for specific categories and a 0% rate on exports.

> **Corrected: there is no 8% services rate.** This guide previously gave the
> standard rate as "10% on goods and 8% on services". The Belastingdienst lists
> the BTW rates as **10%, 0%, 5% and 25%** — four rates, and 8% is not among
> them — and states that the general 10% rate applies to "de levering en of
> invoer van goederen, **alsook het verrichten van diensten**": the supply or
> import of goods *as well as the provision of services*. A supplier of services
