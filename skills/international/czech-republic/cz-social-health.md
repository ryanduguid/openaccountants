...
description: >
  Czech self-employed social and health insurance contributions. Covers social insurance (29.2% of assessment base), health insurance (13.5% of assessment base), minimum advance payments, and lump-sum tax (paušální daň).
version: 0.1
jurisdiction: CZ
tax_year: 2025
...
# Czech Social + Health Insurance v0.1
...
[To be completed. Cite primary sources: Zákon o pojistném na sociální zabezpečení]
