...
name: ng-income-tax
description: >
  Nigerian personal income tax for self-employed individuals. Covers progressive brackets (7–24%), minimum tax (1% of gross income), CIT for companies, and FIRS self-assessment.
version: 0.1
jurisdiction: NG
tax_year: 2025
...
# Nigeria Personal Income Tax v0.1
...
[To be completed. Cite primary sources: PITA (Personal Income Tax Act)]
