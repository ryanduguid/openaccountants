...
name: ro-income-tax
description: >
  Romanian income tax (Declarația Unică / Single Declaration) for self-employed individuals (PFA). Covers flat 10% rate, norma de venit option, real income system, and annual filing by 25 May.
version: 0.1
jurisdiction: RO
tax_year: 2025
...
# Romania Income Tax (Declarația Unică) v0.1
...
[To be completed. Cite primary sources: Codul Fiscal]
