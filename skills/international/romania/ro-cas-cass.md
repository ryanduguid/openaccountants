...
name: ro-cas-cass
description: >
  Romanian self-employed social and health contributions (CAS/CASS). Covers CAS (25% on income above 12 minimum wages) and CASS (10% on income above 6 minimum wages), declared via Declarația Unică.
version: 0.1
jurisdiction: RO
tax_year: 2025
