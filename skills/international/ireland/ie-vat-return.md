...
name: ie-vat-return
description: >
  Irish VAT return (VAT3) for self-employed individuals. Covers standard (23%), reduced (13.5%/9%), second reduced (4.8%), and zero rates, reverse charge, flat-rate farmer scheme exclusion, and two-monthly filing.
version: 0.1
jurisdiction: IE
tax_year: 2025
...
[To be completed. Cite primary sources: VATCA 2010, EU VAT Directive]
