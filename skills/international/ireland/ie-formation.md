...
- **Employer PRSI Class A1** — 11.15% Jan-Sep 2025; 11.25% from 1 Oct 2025; **11.40% from 1 Oct 2026** on the standard rate band — sub-class A1. Lower employer rates apply to low-earnings sub-classes, rising to 9.15% from 1 Oct 2026 where weekly income is EUR 441 or less. Every PRSI rate steps up 0.15% each 1 October under a legislated roadmap running to October 2028, so read the rate off the payroll period, not off the year %
