---
name: Mali Company Formation & Entity Choice
...
# Mali Company Formation & Entity Choice
...
- **Société à Responsabilité Limitée (SARL)** — Limited liability company — the most common SME vehicle  _(OHADA Uniform Act on Commercial Companies (AUSCGIE))_
- **Société Anonyme (SA)** — Public limited company — for larger businesses; can be single-shareholder (SAU)  _(OHADA Uniform Act on Commercial Companies (AUSCGIE))_
- **Entreprise Individuelle** — Sole proprietorship — no separate legal personality, owner is personally liable  _(OHADA Uniform Act on Commercial Companies (AUSCGIE))_
- **SARL minimum share capital** — XOF 5,000 minimum legal capital (par value XOF 5,000 per share); higher capital often recommended for credibility XOF  _(OHADA Uniform Act on Commercial Companies (AUSCGIE))_
- **SA minimum share capital** — XOF 10,000,000 (XOF 100,000,000 if making a public offering) XOF  _(OHADA Uniform Act on Commercial Companies (AUSCGIE))_
