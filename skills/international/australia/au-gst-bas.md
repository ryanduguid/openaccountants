...
name: au-gst-bas
description: >
  Australian GST component of the Business Activity Statement (BAS). Covers GST rate (10%), input tax credits, GST-free supplies, registration threshold (K), cash vs accrual, and simplified BAS.
version: 0.1
jurisdiction: AU
tax_year: 2025
...
[To be completed. Cite primary sources: GST Act 1999]
