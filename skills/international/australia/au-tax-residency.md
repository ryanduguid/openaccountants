...
# Australia — Tax Residency Rules — Skill v1.0
...
1. Permanent home: resident of the country where permanent home is available
2. Centre of vital interests: if homes in both, resident where personal/economic ties are closer
3. Habitual abode: if still unclear, where person habitually abides
4. Nationality: if still unclear, by nationality
