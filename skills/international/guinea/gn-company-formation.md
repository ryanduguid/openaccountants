...
> **The uniform act has been read, and this guide did not match it.** Guinea is
...
> CFA**, and Guinea does not use the CFA franc. Restating 1,000,000 or 10,000,000
> as the same number of GNF is not a conversion — it changes the requirement by an
> order of magnitude. The Act contains no clause converting its amounts for member
> states outside the CFA zone. [RESEARCH GAP — how Guinea applies the article 311
> and 387 amounts in GNF, and whether it has enacted contrary national provisions
