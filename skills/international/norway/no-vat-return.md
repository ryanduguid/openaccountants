...
name: no-vat-return
description: >
  Norwegian VAT return (MVA-melding) for self-employed individuals. Covers standard (25%), reduced food (15%), low (12%) rates, bimonthly filing, and NOK 50K registration threshold.
version: 0.1
jurisdiction: NO
tax_year: 2025
...
[To be completed. Cite primary sources: Merverdiavgiftsloven]
