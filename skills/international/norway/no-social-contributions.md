...
description: >
  Norwegian self-employed social contributions (trygdeavgift) for enkeltpersonforetak. Covers the 11.0% rate on personal income, minimum threshold, and interaction with trinnskatt.
version: 0.1
jurisdiction: NO
tax_year: 2025
...
# Norway Social Contributions (Trygdeavgift) v0.1
...
[To be completed. Cite primary sources: Folketrygdloven]
