...
- **Default = "not a settled regime."** Never tell a user there is a clear crypto tax rate or a clear legal pathway. There is not. **Re-checked September 2026 and unchanged**: law 42.25 is still a draft and the CGI still carries no crypto provision.
