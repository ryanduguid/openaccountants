...
description: >
  South African provisional tax (IRP6) for self-employed individuals. Covers first provisional (Aug), second provisional (Feb), third voluntary (Sep), and penalties for underestimation.
version: 0.1
jurisdiction: ZA
tax_year: 2025
...
# South Africa Provisional Tax (IRP6) v0.1
...
[To be completed. Cite primary sources: ITA s.89 Fourth Schedule]
