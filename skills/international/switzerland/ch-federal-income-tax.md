...
description: >
  Swiss federal income tax (direkte Bundessteuer/impôt fédéral direct) for self-employed individuals. Covers federal progressive brackets (0.77–11.5%), business deductions, and AHV/IV deductibility.
version: 0.1
jurisdiction: CH
tax_year: 2025
...
# Switzerland Federal Income Tax v0.1
...
[To be completed. Cite primary sources: DBG (Bundesgesetz über die direkte Bundessteuer)]
