...
name: ch-vat-return
description: >
  Swiss VAT return (MWST-Abrechnung) for self-employed individuals. Covers standard (8.1%), reduced (2.6%), accommodation (3.8%) rates, CHF 100K registration threshold, and quarterly filing via ESTV.
version: 0.1
jurisdiction: CH
tax_year: 2025
...
[To be completed. Cite primary sources: MWSTG]
