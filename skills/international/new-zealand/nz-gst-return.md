...
name: nz-gst-return
description: >
  New Zealand GST return (GST101A) for self-employed individuals. Covers GST rate (15%), zero-rated supplies, exempt supplies, registration threshold (K), and filing frequencies.
version: 0.1
jurisdiction: NZ
tax_year: 2025
...
[To be completed. Cite primary sources: GSTA 1985]
