---
name: sl-tax-overview
description: "Source-cited draft: tax overview for Sierra Leone (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: SL
tax_year: 2025
...
Sierra Leone operates a residence-based direct tax system administered by the National Revenue Authority (NRA) under the Income Tax Act 2000 (as amended). The headline taxes are personal income tax (PAYE), corporate income tax (**25%** to the 2025 year of assessment, **30%** for residents from the Finance Act 2026, with non-residents remaining at **25%**), a 15% Goods and Services Tax (GST), and NASSIT social-security contributions.

- **Tax authority** — National Revenue Authority (NRA)  _([National Revenue Authority Act 2002](https://www.nra.gov.sl/))_
- **Currency** — New Leone (SLE / NLe); redenominated from old Leone in 2021 by removing three zeros ((approx — confirm))  _(Bank of Sierra Leone redenomination)_
- **Tax year** — Calendar year, 1 January to 31 December  _(Income Tax Act 2000)_
