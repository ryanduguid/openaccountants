...
description: >
  Italian INPS social contributions for self-employed professionals (Gestione Separata). Covers contribution rate (~26.07%), minimale contributivo, maximale, and payment schedule (acconto/saldo).
version: 0.1
jurisdiction: IT
tax_year: 2025
...
[To be completed. Cite primary sources: L. 335/1995, INPS circulars]
