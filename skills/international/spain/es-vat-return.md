...
name: es-vat-return
description: >
  Spanish VAT return (IVA — Modelo 303) for autónomos. Covers standard (21%), reduced (10%), super-reduced (4%) rates, quarterly filing, and recargo de equivalencia for retail.
version: 0.1
jurisdiction: ES
tax_year: 2025
...
# Spain VAT Return (Modelo 303) v0.1
...
[To be completed. Cite primary sources: LIVA (Ley 37/1992), EU VAT Directive]
