...
description: >
  Spanish quarterly estimated tax payments (Modelo 130) for autónomos under estimación directa. Covers the 20% rate on cumulative net income, deductions for prior payments, and filing deadlines.
version: 0.1
jurisdiction: ES
tax_year: 2025
...
# Spain Estimated Tax (Modelo 130) v0.1
...
[To be completed. Cite primary sources: LIRPF art. 101]
