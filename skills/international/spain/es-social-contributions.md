...
description: >
  Spanish self-employed social contributions (cuota de autónomos / RETA). Covers the 2023+ income-based contribution system, contribution bases by income tranche, and payment schedule.
version: 0.1
jurisdiction: ES
tax_year: 2025
...
# Spain Social Contributions (RETA) v0.1
...
[To be completed. Cite primary sources: LGSS, RD 504/2022]
