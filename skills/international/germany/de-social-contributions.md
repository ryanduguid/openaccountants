...
description: >
  German social insurance contributions for self-employed individuals. Covers voluntary/mandatory health insurance, pension insurance (Künstlersozialkasse for artists/writers), and long-term care insurance.
version: 0.1
jurisdiction: DE
tax_year: 2025
...
# Germany Social Contributions v0.1
...
[To be completed. Cite primary sources: SGB IV, SGB V, SGB VI, KSVG]
