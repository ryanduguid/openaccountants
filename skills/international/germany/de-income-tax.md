...
name: de-income-tax
description: >
  German income tax return (Einkommensteuererklärung) for self-employed individuals (Freiberufler and Gewerbetreibende). Covers Anlage S/G, progressive brackets (14–45%), Grundfreibetrag, Solidaritätszuschlag, and Kirchensteuer.
version: 0.1
jurisdiction: DE
tax_year: 2025
...
- **Forms:** ESt 1 A, Anlage S, Anlage G
...
[To be completed. Cite primary sources: EStG, SolzG]
