---
name: Madagascar Payroll & Social Contributions
description: "Source-cited draft: payroll & social contributions for Madagascar (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: MG
domain: payroll
role: compute
tax_year: 2025
...
# Madagascar Payroll & Social Contributions
...
- **PAYE-equivalent withholding** — IRSA is withheld monthly from gross salary by the employer (progressive 0%–20%, minimum MGA 3,000)  _(Code Général des Impôts (Madagascar) — IRSA — https://taxsummaries.pwc.com/madagascar/individual/tax-administration)_
- **IRSA remittance deadline** — Before the 15th of the month following the salary payment  _(Code Général des Impôts (Madagascar) — IRSA — https://taxsummaries.pwc.com/madagascar/individual/tax-administration)_
...
- **Professional training contribution** — Equal to the social-security (CNAPS) contribution amount (approx — confirm)  _(Code du Travail (Madagascar) — https://taxsummaries.pwc.com/madagascar/corporate/other-taxes)_
