...
name: kr-income-tax
description: >
  South Korean comprehensive income tax (종합소득세) for self-employed individuals. Covers progressive brackets (6–45%), simplified bookkeeping vs double-entry, standard deduction rates by business type, and local income tax (10% surtax).
version: 0.1
jurisdiction: KR
tax_year: 2025
...
# South Korea Income Tax (종합소득세) v0.1
...
[To be completed. Cite primary sources: 소득세법 (Income Tax Act)]
