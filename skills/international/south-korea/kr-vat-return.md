...
name: kr-vat-return
description: >
  South Korean VAT return (부가가치세) for self-employed individuals. Covers standard rate (10%), zero rate for exports, simplified taxation for small businesses, semi-annual filing, and electronic tax invoicing.
version: 0.1
jurisdiction: KR
tax_year: 2025
...
# South Korea VAT Return (부가가치세) v0.1
...
[To be completed. Cite primary sources: 부가가치세법 (VAT Act)]
