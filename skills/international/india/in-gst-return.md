...
name: in-gst-return
description: >
  Indian GST return (GSTR-3B + GSTR-1) for self-employed individuals. Covers CGST/SGST/IGST, standard rates (5/12/18/28%), composition scheme, input tax credit, and monthly/quarterly filing.
version: 0.1
jurisdiction: IN
tax_year: 2025
...
[To be completed. Cite primary sources: CGST Act 2017, IGST Act 2017]
