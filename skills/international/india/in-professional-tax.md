...
- **New Tax Regime (Section 115BAC)** — Under the new regime (default from FY 2023-24), the standard deduction of ₹75,000 covers both the standard deduction and profession tax deduction. Separate Section 16(iii) claim may not be additionally available under new regime.  _(Section 115BAC)_
