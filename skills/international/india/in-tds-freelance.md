...
description: >
  Indian TDS on payments to freelancers/contractors. Covers Section 194J (professional services, 10%), Section 194C (contracts, 1/2%), TDS return filing (Form 26Q), and TDS certificates (Form 16A).
version: 0.1
jurisdiction: IN
tax_year: 2025
...
# India TDS on Freelance Payments v0.1
...
[To be completed. Cite primary sources: IT Act 1961 s.194C/194J]
