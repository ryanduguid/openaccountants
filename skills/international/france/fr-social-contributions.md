...
description: >
  French self-employed social contributions (cotisations URSSAF). Covers maladie, retraite de base, retraite complémentaire, invalidité-décès, allocations familiales, and CSG/CRDS.
version: 0.1
jurisdiction: FR
tax_year: 2025
...
# France Social Contributions (URSSAF) v0.1
...
- **Forms:** DSI (Déclaration Sociale des Indépendants)
...
[To be completed. Cite primary sources: CSS, Code de la Sécurité Sociale]
