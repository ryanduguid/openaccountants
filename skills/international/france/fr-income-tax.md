...
name: fr-income-tax
description: >
  French income tax return (Déclaration de Revenus 2042/2042-C-PRO) for self-employed professionals under the régime réel. Covers BNC (bénéfices non commerciaux), BIC (bénéfices industriels et commerciaux), quotient familial, progressive brackets, and prélèvement à la source.
version: 0.1
jurisdiction: FR
tax_year: 2025
...
[To be completed. Cite primary sources: CGI art. 197, BOI]
