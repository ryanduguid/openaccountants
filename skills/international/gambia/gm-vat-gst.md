---
name: Gambia VAT / GST
description: "Source-cited draft: vat / gst for Gambia (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: GM
domain: vat-gst
role: compute
tax_year: 2025
...
- **VAT de-registration** — Available after 2 years if annual turnover falls below D1,000,000 GMD  _(Income and Value Added Tax Act — https://www.gra.gm/domestic-faqs)_
- **VAT filing frequency** — Monthly — return and payment within 15 days after the end of the month  _(Income and Value Added Tax Act — https://www.gra.gm/domestic-faqs)_
- **Non-resident / digital suppliers** — Non-resident digital service suppliers are required to register for tax and obtain a TIN (2025 reform)  _(Income and Value Added Tax Act — https://www.igrowventure.com/gambia-in-the-2025-tax-reforms/)_
- **Input VAT credit** — Registered persons may deduct input VAT on taxable purchases against output VAT ((approx — confirm)) (approx — confirm)  _(Income and Value Added Tax Act)_
