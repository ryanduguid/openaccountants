...
- **IGI registration threshold — both figures confirmed from the Regulation, plus two rules this row was missing** — **Article 1 of the *Reglament de l'impost general indirecte*** (Decret del 2-7-2014), made under article 5.4 of the Law: a person is **not** treated as an *empresari o professional* for IGI where supplies of goods and services do not exceed **EUR 40,000 a year**, and the threshold is **EUR 150,000 for agricultural ***and livestock*** activities** — the row said "agricultural" and the statute says *agrícoles i ramaderes*. Both figures, carried here on three commercial hosts, are right. **What the row omits:** (i) art. 1(3) applies the thresholds **jointly across all activities** — exceed EUR 40,000 on the non-farm activities and you are a trader **for every activity you carry on**, and even below that, exceeding EUR 150,000 once farming is included has the same effect; (ii) **art. 1(4): in the liquidation period in which the threshold is crossed, the taxpayer must regularise the tax treatment of the operations of the *whole calendar year***. Crossing the threshold in, say, November reaches back to January — it is not prospective  _([Reglament de l'IGI, art. 1](https://bopadocuments.blob.core.windows.net/bopa-documents/026040/html/ga26040038.html))_

**5.8 IGI Rates** — all five rates confirmed against the consolidated Law; **two entries in the 0% row are wrong**  _([Llei 11/2012 IGI, text refós, arts. 57–60 bis](https://bopadocuments.blob.core.windows.net/bopa-documents/031055/html/1_GD20190614_13_50_37.html))_

| IGI Rate | Article | Applies To |
| --- | --- | --- |
| 0% (*superreduït*) | 59 | Thirteen heads, including hospital and health services by public/para-public bodies; care by health professionals **holding a current CASS agreement**, where the patient is affiliated and the act is at least partly reimbursed; social assistance; **education** of children and youth, childcare, school, university and postgraduate teaching; private lessons on curriculum subjects; sport and physical education; ambulance transport; **letting of buildings used exclusively as dwellings**; **medicines reimbursable by CASS**; and **stamps and legal-tender stamped effects supplied at no more than face value** |
| 1% (*reduït*) | 58 | Foodstuffs for human or animal consumption **including drinks but expressly excluding alcoholic drinks**, live animals, seeds, plants and ingredients normally used in preparing food; **water**; books, newspapers and magazines **that do not consist only or mainly of advertising** — "mainly" meaning **more than 75% of the publisher's revenue from that source** |
| 2.5% (*especial*) | 60 bis | Passenger transport and its marketing, ***except transport by cable***; libraries, archives and documentation centres; visits to fairs, museums, galleries, monuments, historic sites, botanical gardens, zoos and protected natural areas; theatrical, musical, choreographic, audiovisual and cinematographic performances; educational, cultural or social exhibitions — **the last four heads only where not supplied by public or para-public administrations or by non-profit cultural or social bodies**; and works of art, collectors' items and antiques |
| 4.5% (*general*) | 57 | The residual rate — charged *"sempre que no es prevegi expressament l'aplicació d'un altre tipus"* |
| 9.5% (*incrementat*) | 60 | **Banking and financial services** |

- **⚠ Two corrections to the 0% row above, one of which this table contradicted itself on** — The row previously read *"Medical, education, financial, postal services"*. **"Financial" is wrong and was inconsistent with this table's own last line**: banking and financial services are at **9.5%** under article 60 and appear nowhere in article 59. **"Postal services" is also wrong** — article 59(12) zero-rates the **supply of stamps and stamped effects at no more than face value**, which is not the same thing as postal delivery services. And the row omitted **residential letting** (art. 59(9)), the single head most likely to be asked about  _([Llei 11/2012 IGI, arts. 59–60](https://bopadocuments.blob.core.windows.net/bopa-documents/031055/html/1_GD20190614_13_50_37.html))_
- **⚠ "Transport" at 2.5% has a carve-out that matters in Andorra** — Article 60 bis(1) excludes ***transport per cable*** from the special rate. In a country whose transport of people is substantially ski lifts and cable cars, a reader told simply *"transport: 2.5%"* is being pointed at the wrong rate for a large part of the sector  _([Llei 11/2012 IGI, art. 60 bis](https://bopadocuments.blob.core.windows.net/bopa-documents/031055/html/1_GD20190614_13_50_37.html))_
- **IGI filing frequency — confirmed from the Law, and it is in the Law, not the Regulation** — **Article 78** of the consolidated Law sets the bands on the **immediately preceding year's net turnover for all the taxpayer's activities combined**: under **EUR 250,000** → returns in **July and January**; under **EUR 3,600,000** → **April, July, October and January**; **EUR 3,600,000 or more** → **monthly**. All three bands and all the months as this row had them are right. **Two rules it omits:** a prior year shorter than 12 months is **prorated to the calendar year** before the bands are applied, and **on commencement of activity** — where there is no prior year at all — returns are **quarterly**, or **July and January** if the simplified regime applies. Unusually for this pack, the frequency is **in the Law itself**; unlike the IS return date, it is not delegated  _([Llei 11/2012 IGI, art. 78](https://bopadocuments.blob.core.windows.net/bopa-documents/031055/html/2_GD20190614_13_50_37.html))_
- **Simplified regime — the EUR 100,000 is right, and the regime is more than a threshold** — **Article 74**: available **voluntarily** where supplies do not exceed **EUR 100,000 a year**, measured **excluding disposals of capital assets and excluding IGI itself**, and **prorated** for a part-year start. It must be **applied for before the end of the preceding year** — or, for a new business, **within the month following commencement** — and once elected it **binds for a minimum of three years**, with renunciation again due before the end of the preceding year. **Article 75 is the substance the row never gave:** input tax is **deemed, not actual** — output tax for the period less **3% of turnover for commercial activities** or **1.5% for all other activities**, turnover excluding proceeds of fixed assets used in the business. A taxpayer with real input tax above those percentages loses by electing  _([Llei 11/2012 IGI, arts. 74–75](https://bopadocuments.blob.core.windows.net/bopa-documents/031055/html/2_GD20190614_13_50_37.html))_
...
- **⚠ Crossing the threshold mid-year reopens the whole year, on both sides** — This section treats IGI-registered and not-registered as two states a taxpayer is simply in. **Article 1(4) of the *Reglament de l'IGI*** makes the transition retroactive: in the liquidation period in which the EUR 40,000 (or EUR 150,000 farming) threshold is crossed, the taxpayer must **regularise the tax treatment of the operations of the entire calendar year**. Someone who crosses in November does not start charging IGI in November — they go back to January. Because the IRPF basis above is defined by reference to IGI collected, that regularisation moves the **IRPF** figure for the earlier months too, and the *"full invoice amount = IRPF income"* rule stops holding for a year that was under the threshold when it began. **Not applying the threshold activity-by-activity either**: art. 1(3) makes it a single test across everything the person does  _([Reglament de l'IGI, art. 1(3)–(4)](https://bopadocuments.blob.core.windows.net/bopa-documents/026040/html/ga26040038.html))_
...
| Tax | Rate | Notes |
| --- | --- | --- |
| Corporate tax (IS) | 10% flat (art. 41(1)); **0%** for collective investment undertakings under Llei 10/2008, **not** their management companies (art. 41(2)) | **⚠ The "5% for new companies with net income ≤ EUR 50,000" previously in this cell has been removed.** Article 41 of the consolidated Llei 95/2010 sets two rates and no others, no *bonificació* for new companies appears anywhere in the Law, and its first transitional provision is marked *(derogada)*. `ad-corporate-income-tax` carries the working. If such relief exists it is in another instrument — it is not in the IS Law |
| IGI (indirect / VAT equivalent) | 4.5% standard; 0% / 1% / 2.5% / 9.5% special | All five confirmed against arts. 57–60 bis. See Section 5.8 — **two entries in the 0% list were wrong** |
