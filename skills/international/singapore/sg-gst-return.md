...
name: sg-gst-return
description: >
  Singapore GST return (GST F5) for self-employed individuals. Covers standard rate (9%), zero-rated and exempt supplies, registration threshold (SM), quarterly filing, and input tax claims.
version: 0.1
jurisdiction: SG
tax_year: 2025
...
[To be completed. Cite primary sources: GST Act (Singapore)]
