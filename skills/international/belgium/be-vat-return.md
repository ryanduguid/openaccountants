...
name: be-vat-return
description: >
  Belgian VAT return (BTW-aangifte / Déclaration TVA) for self-employed individuals. Covers standard (21%), reduced (6%/12%) rates, monthly/quarterly filing, and EU Listing.
version: 0.1
jurisdiction: BE
tax_year: 2025
...
[To be completed. Cite primary sources: WBTW/CTVA, EU VAT Directive]
