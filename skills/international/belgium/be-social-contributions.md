...
description: >
  Belgian self-employed social contributions (sociale bijdragen). Covers quarterly contributions (20.5% below threshold, 14.16% above), minimum contribution, management company interaction, and supplementary pension (VAPZ/PLCI).
version: 0.1
jurisdiction: BE
tax_year: 2025
...
# Belgium Social Contributions v0.1
...
- **Forms:** Social insurance fund statement
...
[To be completed. Cite primary sources: RSZ wet, KB zelfstandigen]
