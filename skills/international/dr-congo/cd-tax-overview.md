...
# DR Congo Tax Overview

## The DRC tax system at a glance
...
- **Does VAT (TVA) exist?** — Yes — standard VAT (Taxe sur la Valeur Ajoutée) at 16% percent  _([Ordonnance-loi n° 10/001 instituant la TVA](https://taxsummaries.pwc.com/democratic-republic-of-the-congo/corporate/other-taxes))_
...
- **VAT return frequency and deadline** — Monthly — by the 15th of the month following the taxable transactions  _([Ordonnance-loi n° 10/001 instituant la TVA](https://mjgroup.africa/navigating-vat-in-the-drc-a-guide-for-importers-exporters/))_
