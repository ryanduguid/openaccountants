---
name: Armenia Company Formation & Entity Choice
description: "Source-cited draft: company formation & entity choice for Armenia (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: AM
domain: formation
role: reference
tax_year: 2025
...
Armenia offers fast, fully electronic company formation through the State Register of Legal Entities of the Ministry of Justice. The limited liability company (LLC) is the most common vehicle, with no minimum share capital and 100% foreign ownership permitted.
...
- **Minimum share capital (LLC)** — No statutory minimum — nominal capital (e.g. AMD 1) is sufficient AMD (AMD)  _(Law on Limited Liability Companies of the Republic of Armenia (https://armenian-lawyer.com/immigration/registering-an-llc-in-armenia-one%E2%80%91day-incorporation-tax-registration-and-first-compliance-steps/))_
...
- **Tax regime election window** — Company must elect its tax regime (general, turnover tax or micro) within about 20 days of incorporation, otherwise defaults to the general regime (18% CIT + 20% VAT) days ((approx — confirm) the 20-day window)  _(Tax Code of the Republic of Armenia (https://armenian-lawyer.com/immigration/registering-an-llc-in-armenia-one%E2%80%91day-incorporation-tax-registration-and-first-compliance-steps/))_
- **Annual accounts and approval** — Annual report, balance sheet and profit/loss accounts must be approved by the shareholders' meeting within 6 months of the fiscal year-end  _(Law on Limited Liability Companies of the Republic of Armenia (https://gsl.org/en/offshore/offshore-zones/south-southeast-asia/armenia/))_
