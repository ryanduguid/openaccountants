...
name: mx-income-tax
description: >
  Mexican income tax (ISR — Declaración Anual PF) for self-employed individuals (actividad empresarial y profesional). Covers progressive brackets (1.92–35%), deductions personales, and annual filing via SAT portal.
version: 0.1
jurisdiction: MX
tax_year: 2025
...
[To be completed. Cite primary sources: LISR (Ley del ISR)]
