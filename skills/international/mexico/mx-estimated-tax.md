...
description: >
  Mexican provisional tax payments (pagos provisionales de ISR) for self-employed individuals. Covers monthly computation, accumulated income, coefficient of utility, and SAT filing.
version: 0.1
jurisdiction: MX
tax_year: 2025
...
# Mexico Estimated Tax (Pagos Provisionales) v0.1
...
[To be completed. Cite primary sources: LISR art. 106]
