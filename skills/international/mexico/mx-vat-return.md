...
name: mx-vat-return
description: >
  Mexican VAT return (IVA — Declaración Mensual) for self-employed individuals. Covers standard rate (16%), zero rate (food, medicine, exports), exempt activities, monthly filing, and DIOT informative declaration.
version: 0.1
jurisdiction: MX
tax_year: 2025
...
[To be completed. Cite primary sources: LIVA (Ley del IVA)]
