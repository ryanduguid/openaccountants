...
name: cl-vat-return
description: >
  Chilean VAT return (IVA — Formulario 29) for self-employed individuals. Covers standard rate (19%), monthly filing, débito/crédito fiscal, and electronic invoicing (DTE/SII).
version: 0.1
jurisdiction: CL
tax_year: 2025
...
[To be completed. Cite primary sources: DL 825 (Ley de IVA)]
