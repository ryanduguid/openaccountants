...
description: >
  Chilean self-employed social contributions (cotizaciones previsionales). Covers AFP pension (mandatory since 2019 phase-in), Fonasa/Isapre health, and SIS insurance. Withheld from boletas de honorarios.
version: 0.1
jurisdiction: CL
tax_year: 2025
...
# Chile Social Contributions (AFP/Fonasa) v0.1
...
- **Forms:** Certificado de cotizaciones
...
[To be completed. Cite primary sources: Ley 21.133, DL 3.500]
