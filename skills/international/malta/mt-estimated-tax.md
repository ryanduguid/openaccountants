...
description: >
  Maltese provisional tax for self-employed individuals. Covers the three-instalment schedule (20%/30%/50%), calculation based on prior-year tax, and interaction with TA24 final assessment.
version: 0.1
jurisdiction: MT
tax_year: 2025
...
[To be completed. Cite primary sources: Income Tax Act Cap. 123]
