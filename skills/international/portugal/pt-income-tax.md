...
name: pt-income-tax
description: >
  Portuguese income tax return (IRS — Modelo 3) for self-employed individuals. Covers Cat. B income, simplified regime vs contabilidade organizada, progressive brackets (14.5–48%), surcharge, and NHR regime exclusion.
version: 0.1
jurisdiction: PT
tax_year: 2025
...
[To be completed. Cite primary sources: CIRS (Código do IRS)]
