...
name: pt-vat-return
description: >
  Portuguese VAT return (Declaração Periódica de IVA) for self-employed individuals. Covers standard (23%), intermediate (13%), reduced (6%) rates, monthly/quarterly filing, and isenção de IVA for small businesses.
version: 0.1
jurisdiction: PT
tax_year: 2025
...
[To be completed. Cite primary sources: CIVA, EU VAT Directive]
