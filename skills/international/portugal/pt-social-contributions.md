...
description: >
  Portuguese self-employed social contributions (contribuições para a Segurança Social). Covers the quarterly declaration, 21.4% rate, relevant income computation from prior-quarter turnover, and exemption in first 12 months.
version: 0.1
jurisdiction: PT
tax_year: 2025
...
# Portugal Social Contributions v0.1
...
[To be completed. Cite primary sources: Código Contributivo]
