...
name: co-income-tax
description: >
  Colombian income tax return (Declaración de Renta PF) for self-employed individuals. Covers cédula general, progressive brackets, renta presuntiva, and filing thresholds in UVT.
version: 0.1
jurisdiction: CO
tax_year: 2025
...
# Colombia Income Tax (Renta PF) v0.1
...
[To be completed. Cite primary sources: Estatuto Tributario]
