---
name: Montenegro Company Formation & Entity Choice
description: "Source-cited draft: company formation & entity choice for Montenegro (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: ME
domain: formation
role: reference
tax_year: 2025
...
# Montenegro Company Formation & Entity Choice
...
## Share capital, steps and timeline

- **Minimum share capital — DOO** — €1 EUR  _(Company Law (Zakon o privrednim društvima) — https://multilaw.com/Multilaw/Multilaw/Global_Business_Entities_Guide/Montenegro_-_Limited_Liability_Company.aspx)_
- **Minimum share capital — AD (joint-stock)** — €25,000 EUR (approx — confirm current statutory minimum)  _(Company Law (Zakon o privrednim društvima) — https://multilaw.com/Multilaw/Multilaw/Global_Business_Entities_Guide/Montenegro_-_Limited_Liability_Company.aspx)_
- **Registration authority** — Central Registry of Business Entities (CRPS), under the Tax Administration  _(Company Law (Zakon o privrednim društvima) — https://psc.gov.me/en/registracija-biznisa-i-poslovanje)_
- **Core incorporation steps** — Reserve name at CRPS; notarize founding act/agreement and statute; deposit capital in a bank; file with CRPS; obtain Tax ID (PIB) and VAT registration if applicable  _(Company Law (Zakon o privrednim društvima) — https://saaccounting.me/blog/company-registration-montenegro)_
- **Typical registration timeline** — Approximately 7 to 10 working days for CRPS registration; ~3-4 weeks including bank account and tax setup (approx — practitioner estimate)  _(Company Law (Zakon o privrednim društvima) — https://saaccounting.me/blog/company-registration-montenegro)_
- **Foreign ownership** — 100% foreign ownership permitted; no local partner required  _(Company Law (Zakon o privrednim društvima) — https://saaccounting.me/blog/company-registration-montenegro)_
