...
- Available to freelancers/micro entrepreneurs with **annual revenue ≤ €30,000** (raised from €18,000 effective **1 Jan 2025**).
...
- **AUDIT FLASH POINT — professional services (IT, consulting, marketing, intellectual/online activities) CANNOT use the lump-sum regime.** It is limited to specific listed crafts and small local trades. Confirm the activity qualifies before recommending it.
...
Plus a **municipal surtax** (13%, or 15% in Podgorica/Cetinje) on the PIT amount — so residence municipality matters slightly.
