---
name: Tajikistan Personal Income Tax
description: "Source-cited draft: personal income tax for Tajikistan (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: TJ
domain: income-tax
role: compute
tax_year: 2025
...
- **Employee social contribution deductible before PIT** — 1 percent (deducted before computing income tax)  _(Tax Code of the Republic of Tajikistan)_
- **Resident tax base** — Worldwide income  _(Tax Code of the Republic of Tajikistan)_
- **Non-resident tax base** — Tajik-source income only  _(Tax Code of the Republic of Tajikistan)_
- **Residence test** — Physical presence of 183 days or more in any consecutive 12-month period ending in the tax year (approx — confirm)  _(Tax Code of the Republic of Tajikistan)_
- **Employer withholding (PAYE-equivalent)** — Employer withholds income tax at source from employment income each month  _(Tax Code of the Republic of Tajikistan)_
- **Annual return deadline (self-assessed income)** — By 1 April of the year following the tax year (approx — confirm)  _(Tax Code of the Republic of Tajikistan)_
