...
description: >
  Ontario provincial income tax for self-employed individuals. Covers Ontario tax brackets, surtax, Ontario Health Premium, and Ontario-specific credits (OEPTC, OSTC).
version: 0.1
jurisdiction: CA-ON
tax_year: 2025
...
# Ontario Individual Return v0.1
...
[To be completed. Cite primary sources: Ontario ITA]
