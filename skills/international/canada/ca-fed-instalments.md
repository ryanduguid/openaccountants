...
description: >
  Canadian federal quarterly instalment requirements for self-employed individuals. Covers the ,000 net tax owing threshold, instalment calculation methods, and instalment interest charges.
version: 0.1
jurisdiction: CA-FED
tax_year: 2025
...
# Canada Quarterly Instalments v0.1
...
[To be completed. Cite primary sources: ITA s.156]
