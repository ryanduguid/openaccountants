...
name: ca-fed-cpp-ei
description: >
  Canadian federal CPP and EI contributions for self-employed individuals. Covers CPP2, CPP enhancement, self-employed CPP rate (double the employee rate), EI opt-in for self-employed, and Schedule 8.
version: 0.1
jurisdiction: CA-FED
tax_year: 2025
...
# Canada CPP/EI Self-Employed v0.1
...
[To be completed. Cite primary sources: CPP Act, EI Act]
