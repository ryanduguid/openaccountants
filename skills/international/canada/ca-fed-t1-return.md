...
description: >
  Canadian federal individual income tax return (T1 General) for self-employed sole proprietors. Covers total income, net income, taxable income, federal tax calculation, basic personal amount, and final balance owing/refund.
version: 0.1
jurisdiction: CA-FED
tax_year: 2025
...
# Canada T1 Individual Return v0.1
...
[To be completed. Cite primary sources: ITA (Canada)]
