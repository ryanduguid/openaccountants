...
name: qc-qst-return
description: >
  Quebec Sales Tax (QST) return for self-employed individuals. Covers QST rate (9.975%), input tax refunds, small supplier threshold, and interaction with federal GST.
version: 0.1
jurisdiction: CA-QC
tax_year: 2025
...
[To be completed. Cite primary sources: QSTA]
