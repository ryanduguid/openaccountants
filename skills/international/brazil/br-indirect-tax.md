...
description: >
  Brazilian indirect tax obligations (ICMS/ISS/IPI) for self-employed service providers and small businesses. Covers ISS (municipal, 2–5%), ICMS (state), IPI (federal), and interaction with Simples Nacional.
version: 0.1
jurisdiction: BR
tax_year: 2025
...
# Brazil Indirect Tax (ICMS/ISS/IPI) v0.1
...
[To be completed. Cite primary sources: LC 116/2003, LC 87/1996]
