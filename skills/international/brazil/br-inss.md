...
name: br-inss
description: >
  Brazilian INSS social contributions for self-employed individuals (contribuinte individual). Covers the 20% rate (plan normal) or 11% (simplified plan), contribution cap, and GPS payment.
version: 0.1
jurisdiction: BR
tax_year: 2025
...
# Brazil INSS Contributions v0.1
...
- **Forms:** GPS (Guia da Previdência Social)
...
[To be completed. Cite primary sources: Lei 8.212/1991]
