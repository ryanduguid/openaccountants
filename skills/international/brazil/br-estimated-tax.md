...
description: >
  Brazilian monthly estimated tax (Carnê-Leão) for self-employed individuals receiving payments from individuals. Covers monthly computation, DARF payment, and carry-forward to DIRPF.
version: 0.1
jurisdiction: BR
tax_year: 2025
...
# Brazil Estimated Tax (Carnê-Leão) v0.1
...
[To be completed. Cite primary sources: RIR/2018 art. 118–121]
