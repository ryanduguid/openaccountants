...
description: >
  Brazilian Simples Nacional unified tax regime for MEI and small businesses. Covers MEI monthly DAS (fixed ~R), Simples Nacional progressive tables (Anexos I–V), revenue thresholds, and DASN-SIMEI annual declaration.
version: 0.1
jurisdiction: BR
tax_year: 2025
...
[To be completed. Cite primary sources: LC 123/2006]
