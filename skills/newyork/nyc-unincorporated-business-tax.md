...
description: >
  NYC Unincorporated Business Tax for sole proprietors and SMLLCs operating in the five boroughs. Covers the 4% rate, K exemption, UBT credit against NYC resident tax (Form IT-219), and Form NYC-202.
version: 0.1
...
# NYC Unincorporated Business Tax v0.1
...
- **Forms:** Form NYC-202, Form IT-219
...
[To be completed. Cite primary sources: NYC Admin Code §11-503]
