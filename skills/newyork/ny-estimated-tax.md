...
description: >
  New York State estimated tax (Form IT-2105) for self-employed individuals. Covers quarterly instalment requirements, MCTMT estimated payments, and underpayment penalty computation.
version: 0.1
jurisdiction: US-NY
tax_year: 2025
category: state
...
[To be completed. Cite primary sources: NY Tax Law §685]
