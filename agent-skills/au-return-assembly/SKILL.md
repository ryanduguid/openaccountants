...
| MLS thresholds (2024-25) | Single: $97,000; Family: $194,000 | Below threshold = no MLS regardless of PHI |
...
_Source: [OpenAccountants](https://openaccountants.com/skills/au-return-assembly) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
