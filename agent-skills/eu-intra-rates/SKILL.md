---
name: eu-intra-rates
description: "OpenAccountants tax and accounting reference for INTL: eu intra rates. Use for cross-border questions in INTL (tax year )."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/eu-intra-rates"
  obligation: OTHER
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/eu-intra-rates) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
