...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/id-payroll-pph21"
  tax_year: 2025
  obligation: PAY
  reviewed_by: "pending depends_on: - foundation"
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/id-payroll-pph21) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. Reviewed by pending depends_on: - foundation. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
