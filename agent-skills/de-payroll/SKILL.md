...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/de-payroll"
  tax_year: 2025
  obligation: PAY
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/de-payroll) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
