...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/be-social-contributions"
  obligation: SSC
---
...
- NEVER tell a client that social contributions have no upper limit -- there IS a ceiling at EUR 110,562.42
...
ELIF income <= 110,562.42:
    contributions = (75,024.54 x 20.50%) + ((income - 75,024.54) x 14.16%)
ELSE:
    contributions = (75,024.54 x 20.50%) + ((110,562.42 - 75,024.54) x 14.16%)
...
_Source: [OpenAccountants](https://openaccountants.com/skills/be-social-contributions) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
