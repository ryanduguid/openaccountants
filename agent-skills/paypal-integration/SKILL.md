...
description: "> Integration skill for PayPal activity download CSV exports. Activate when the user uploads a PayPal CSV, PayPal activity report, or mentions PayPal transactions. This is one of the messiest exports in common use."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/paypal-integration"
  obligation: INT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/paypal-integration) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
