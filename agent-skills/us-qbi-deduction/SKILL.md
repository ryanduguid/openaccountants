...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/us-qbi-deduction"
  obligation: OTHER
---
...
- Traditional IRA contributions (personal deduction under §219, not attributable to the trade or business — see Edge case 9)
...
If the sole prop has no depreciable property still within its depreciable period (see Step 5), UBIA = $0, and BOTH alternatives = $0. This means the QBI deduction is limited to $0 for taxpayers fully above the phase-in range.
...
Phase-in percentage = (taxable income − threshold) / ($50,000 single or $100,000 MFJ, for TY2025)
...
2. **NEVER apply a 23% §199A rate for ANY tax year.** The 23% rate appeared only in the House-passed version of H.R. 1 (May 2025). The enacted One Big Beautiful Bill Act (P.L. 119-21) kept the rate at 20% and made it permanent. The rate is 20% for 2025, 2026, and all later years unless Congress acts again.
...
11. **NEVER apply the 2026+ OBBBA changes (wider $75,000/$150,000 phase-in ranges, $400 minimum deduction) to a tax year 2025 return.** They are effective only for tax years beginning after December 31, 2025.
...
_Source: [OpenAccountants](https://openaccountants.com/skills/us-qbi-deduction) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
