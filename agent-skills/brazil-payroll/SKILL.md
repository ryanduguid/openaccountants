...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/brazil-payroll"
  obligation: PAY
  reviewed_by: "pending depends_on: - payroll-workflow-base"
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/brazil-payroll) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. Reviewed by pending depends_on: - payroll-workflow-base. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
