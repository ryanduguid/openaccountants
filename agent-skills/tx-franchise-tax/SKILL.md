...
description: "> Texas Franchise Tax for single-member LLCs and other taxable entities. Covers the no-tax-due threshold ($2,470,000 for 2025), EZ computation rate (0.331%), standard computation, Public Information Report (Form 05-102), and annual filing requirements. Primary source: Texas Tax Code Chapter 171."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/tx-franchise-tax"
  tax_year: 2025
  obligation: OTHER
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/tx-franchise-tax) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
