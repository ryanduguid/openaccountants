...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/malta-tax-optimization"
  obligation: OPT
...
**Legislation:** Social Security Act (Cap. 318)
...
_Source: [OpenAccountants](https://openaccountants.com/skills/malta-tax-optimization) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **accountant-reviewed**. Reviewed by Michael Cutajar, CPA (Malta). For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
