...
Apply the bracket scale: first $60,000 × 8%; $60,001-$151,234 × 10%; $151,235-$181,481 × 12%; $181,482-$241,974 × 13%; $241,975-$362,961 × 14%; above $362,961 × 15%. Do not multiply total taxable income by a single rate.

### Step 3: Subtract Non-Refundable Credits
Total credit amounts × 8% (the lowest bracket rate) = credit reduction.
...
- Combined rate on capital gains (50% inclusion): 24% (top bracket, AB -- half of the 48% top combined rate)
...
- NEVER apply a single flat rate to all Alberta income. Alberta is bracketed: 8% on the first $60,000, 10% to $151,234, then 12%/13%/14%/15%.
