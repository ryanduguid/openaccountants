...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/mt-estimated-tax"
  tax_year: 2025
  obligation: EST
...
_Source: [OpenAccountants](https://openaccountants.com/skills/mt-estimated-tax) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **accountant-reviewed**. Reviewed by Michael Cutajar, CPA (Malta). For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
