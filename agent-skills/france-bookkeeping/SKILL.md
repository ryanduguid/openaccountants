...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/france-bookkeeping"
  obligation: BT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/france-bookkeeping) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
