...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/ca-540-individual-return"
  obligation: IT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/ca-540-individual-return) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
