...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/thailand-pit"
  tax_year: 2567 (2024)
  obligation: IT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/thailand-pit) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
