...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/de-income-tax"
  tax_year: 2025
  obligation: IT
---
...
|---|---|---|
| 0 -- 12,096 | 0% | Grundfreibetrag (basic allowance) |
...
_Source: [OpenAccountants](https://openaccountants.com/skills/de-income-tax) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
