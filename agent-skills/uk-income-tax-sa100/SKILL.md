...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/uk-income-tax-sa100"
  tax_year: 2025-26
  obligation: IT
---
...
**R-UK-IT-6 -- savings/property income for 2027-28 onward.** "The 22 / 42 / 47 rates on savings and property income begin 6 April 2027. Flag a return spanning them, and their interaction with the residential finance-cost reducer, which rises to the property basic rate of 22% from 2027–28. A 2026-27 return needs no such flag: those rates are unchanged at 20 / 40 / 45."
...
_Source: [OpenAccountants](https://openaccountants.com/skills/uk-income-tax-sa100) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
