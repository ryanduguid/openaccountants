...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/sg-cpf-medisave"
  tax_year: 2025
  obligation: OTHER
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/sg-cpf-medisave) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
