...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/us-schedule-c-and-se-computation"
  obligation: OTHER
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/us-schedule-c-and-se-computation) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **accountant-reviewed**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
