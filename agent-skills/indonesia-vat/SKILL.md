...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/indonesia-vat"
  tax_year: 2025
  obligation: CT
  reviewed_by: "pending depends_on: - vat-workflow-base"
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/indonesia-vat) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. Reviewed by pending depends_on: - vat-workflow-base. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
