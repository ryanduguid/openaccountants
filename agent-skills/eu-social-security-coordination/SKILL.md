...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/eu-social-security-coordination"
  obligation: SSC
---
...
1. **Single applicable legislation** — you pay in one country only
2. **Equal treatment** — same rights and obligations as nationals of the country where you're covered
...
### Practical guidance for UK-EU cross-border workers
...
**Analysis:**
- Maria pursues activity in ONE state only (Portugal — where work is physically performed)
- Article 11(3)(a) applies: legislation of the state where employed = Portugal
- Maria is subject to Portuguese social security
- German employer must register as employer with Portuguese ISS and pay Portuguese contributions

**Result:** Portugal. The German employer registers with ISS, pays employer/employee contributions per Portuguese rates.

### Scenario B — Posted worker
...
**Analysis:**
- Article 12 posting rules apply
- Duration: 18 months < 24 months maximum ✓
- Johann was previously insured in Germany ✓
- Employer has substantial activity in Germany ✓
- Not replacing another posted worker ✓
...
### Scenario C — Multi-country freelancer
...
**Analysis:**
- Article 13(2) for self-employed in multiple states
- Does Sophie pursue a substantial part in her residence state (Belgium)? 30% ≥ 25% → YES
- Belgium's legislation applies to ALL of Sophie's self-employed activity
...
### Scenario D — Employee plus freelancer in different countries
...
**Analysis:**
- Article 13(3): employed + self-employed in different states
- Employed activity in Italy → Italy's legislation applies to ALL activity
- BUT: the freelance work is ALSO performed in Italy (from home) → this is actually a single-state case
- Italy's legislation applies regardless

**Result:** Italy. INPS contributions on both employed and self-employed income. No German obligation.

### Scenario E — UK employee working partly in EU post-Brexit
...
**Analysis:**
- TCA Protocol Art SSC.12 (multi-state worker)
- James is resident in UK. Does he pursue ≥ 25% in UK? 60% ≥ 25% → YES
- UK legislation applies to all activity
...
_Source: [OpenAccountants](https://openaccountants.com/skills/eu-social-security-coordination) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
