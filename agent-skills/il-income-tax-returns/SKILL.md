...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/il-income-tax-returns"
  tax_year: 2025-2026
  obligation: IT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/il-income-tax-returns) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
