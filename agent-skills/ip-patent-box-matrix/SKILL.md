...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/ip-patent-box-matrix"
  tax_year: 2025
  obligation: IPBOX
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/ip-patent-box-matrix) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
