...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/oman-vat"
  obligation: CT
---
...
- Social insurance (Social Protection Fund, **not PASI** — PASI's pension provisions were repealed by RD 52/2023 art. IV): employer **14.5%**, employee **8%** for Omanis, across five branches; the RO 3,000/month ceiling covers only two of them. Non-Omanis: employer **9%** of basic wage to the savings system, replacing end-of-service gratuity
...
_Source: [OpenAccountants](https://openaccountants.com/skills/oman-vat) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
