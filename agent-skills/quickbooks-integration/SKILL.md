...
description: "> Integration skill for QuickBooks Online CSV exports and imports. Activate when the user uploads a QuickBooks transaction export, bank transaction CSV, or mentions QuickBooks, QBO, or Intuit."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/quickbooks-integration"
  obligation: INT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/quickbooks-integration) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
