...
description: "OpenAccountants tax and accounting reference for INTL: us major partners. Use for cross-border questions in INTL (tax year )."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/us-major-partners"
  obligation: OTHER
---
...
| Technical services | 0% | Art 14 | Independent personal services |
...
| Royalties — general | 15% | Art 12 | Industrial/commercial |
| Royalties — literary/artistic/motion picture | 10% | Art 12 | Cultural royalties |
| Technical services | 0% | Art 7 | Business profits — no WHT without PE |

**Source:** US-South Korea Convention signed 4 June 1976. IRS Table 1.
...
1. **Qualified person test** — publicly traded company, government entity, pension fund, tax-exempt organisation, or individual
2. **Ownership and base erosion test** — ≥50% owned by qualifying residents AND <50% of gross income paid to non-residents
3. **Active trade or business test** — income is connected to an active business in the treaty country
4. **Discretionary benefits** — competent authority may grant benefits if denial would be inappropriate
...
_Source: [OpenAccountants](https://openaccountants.com/skills/us-major-partners) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
