...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/bermuda-tax"
  tax_year: 2025
  obligation: OTHER
---
...
| Filing portal | https://www.gov.bm (Government of Bermuda). ⚠ The `www.tax.gov.bm` address previously given here **does not resolve** |
...
Filing frequency: quarterly. Q1 deadline: April 15. Q2: July 15. Q3: October 15. Q4: January 15. Annual reconciliation: March 15 following year-end. Method: electronic. ⚠ **Not via `tax.gov.bm`** — that host does not resolve; start from https://www.gov.bm.
...
_Source: [OpenAccountants](https://openaccountants.com/skills/bermuda-tax) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
