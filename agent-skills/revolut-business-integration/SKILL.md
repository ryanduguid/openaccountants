...
description: "> Integration skill for Revolut Business statement CSV exports. Activate when the user uploads a Revolut Business CSV, Revolut statement, or mentions Revolut Business transactions."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/revolut-business-integration"
  obligation: INT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/revolut-business-integration) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
