...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/brazil-einvoice"
  obligation: EINV
  reviewed_by: "pending depends_on: - einvoice-workflow-base"
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/brazil-einvoice) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. Reviewed by pending depends_on: - einvoice-workflow-base. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
