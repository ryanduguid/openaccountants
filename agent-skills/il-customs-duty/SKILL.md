...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/il-customs-duty"
  tax_year: 2025-2026
  obligation: CUST
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/il-customs-duty) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
