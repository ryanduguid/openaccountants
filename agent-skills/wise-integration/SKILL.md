...
description: "> Integration skill for Wise (formerly TransferWise) statement CSV exports. Activate when the user uploads a Wise statement, Wise CSV, or mentions Wise, TransferWise, or multi-currency transfers."
...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/wise-integration"
  obligation: INT
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/wise-integration) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
