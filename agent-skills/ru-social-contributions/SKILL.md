...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/ru-social-contributions"
  tax_year: 2026
  obligation: SSC
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/ru-social-contributions) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
