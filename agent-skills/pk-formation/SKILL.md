...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/pk-formation"
  tax_year: 2026
  obligation: FORM
  reviewed_by: "pending depends_on: - company-formation-workflow-base"
---
...
_Source: [OpenAccountants](https://openaccountants.com/skills/pk-formation) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. Reviewed by pending depends_on: - company-formation-workflow-base. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
