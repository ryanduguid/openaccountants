...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/nb-individual-return"
  tax_year: 2025
  obligation: IT
---
...
- First $51,306 × 9.4%
- $51,307 to $102,614 × 14%
- $102,615 to $190,060 × 16%
- Above $190,060 × 19.5%
...
_Source: [OpenAccountants](https://openaccountants.com/skills/nb-individual-return) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
