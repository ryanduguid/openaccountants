...
metadata:
  ...
  openaccountants_url: "https://openaccountants.com/skills/on-individual-return"
  tax_year: 2025
  obligation: IT
---
...
| 105,776 -- 150,000 | 11.16% | 12,446 |
| 150,001 -- 220,000 | 12.16% | 20,958 |
| 220,001+ | 13.16% | 20,958+ |
...
_Source: [OpenAccountants](https://openaccountants.com/skills/on-individual-return) — open tax Guides for AI, reviewed by named CPAs/CAs/EAs. Quality: **source-cited draft**. For always-current figures and named-accountant backing, connect the OpenAccountants MCP server (`openaccountants-mcp`)._
