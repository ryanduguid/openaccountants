# Croatia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Croatia. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `croatia-income-tax.md`
4. `croatia-payroll.md`
5. `croatia-social-contributions.md`
6. `croatia-tax-optimization.md`
7. `croatia-vat-return.md`
8. `hr-company-formation.md`
9. `hr-corporate-income-tax.md`
10. `hr-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Croatia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Croatia."**
...
These Croatia tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
