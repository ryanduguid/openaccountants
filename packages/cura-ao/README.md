# Cura Ao — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Cura Ao. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `cw-company-formation.md`
4. `cw-corporate-income-tax.md`
5. `cw-income-tax.md`
6. `cw-payroll-social.md`
7. `cw-tax-overview.md`
8. `cw-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Cura Ao taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Cura Ao."**
...
These Cura Ao tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
