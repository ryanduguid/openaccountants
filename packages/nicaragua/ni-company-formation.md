---
name: Nicaragua Company Formation & Entity Choice
description: "Source-cited draft: company formation & entity choice for Nicaragua (tax year 2025) — rates, thresholds and rules with primary-source citations. Unverified; pending local-accountant review."
jurisdiction: NI
domain: formation
role: reference
tax_year: 2025
...
# Nicaragua Company Formation & Entity Choice

## Entity types and incorporation

- **Overview of business vehicles in Nicaragua** — The most common vehicle for business in Nicaragua is the Sociedad Anónima (S.A.), governed by the Commercial Code; companies register with the Registro Público Mercantil (commercial registry) and the DGI. Foreigners may fully own a Nicaraguan company.
...
- **Minimum shareholders (S.A.)** — 2  _(Código de Comercio de Nicaragua (https://www.bizlatinhub.com/company-formation-incorporation-in-nicaragua-a-six-step-guide/))_
- **Minimum share capital (S.A.)** — Approx. C$10,000 (about USD 400) is commonly used; there is no strict legally mandated minimum and capital need not be deposited at incorporation NIO ((approx — confirm)) NIO (approx — confirm)  _(Código de Comercio de Nicaragua (https://www.bizlatinhub.com/company-formation-incorporation-in-nicaragua-a-six-step-guide/))_
...
- **Foreign ownership** — 100% foreign ownership of a Nicaraguan S.A. is permitted; a local legal representative is required  _(Código de Comercio de Nicaragua (https://www.bizlatinhub.com/company-formation-incorporation-in-nicaragua-a-six-step-guide/))_
