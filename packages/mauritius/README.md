# Mauritius — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Mauritius. Upload to Claude, ChatGPT, or any AI assistant.
...
2. `intake.md`
3. `mauritius-vat.md`
4. `mu-company-formation.md`
5. `mu-corporate-income-tax.md`
6. `mu-income-tax.md`
7. `mu-payroll-social.md`
8. `mu-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Mauritius taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Mauritius."**
