# Isle of Man — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Isle of Man. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `im-company-formation.md`
4. `im-corporate-income-tax.md`
5. `im-income-tax.md`
6. `im-payroll-social.md`
7. `im-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Isle of Man taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Isle of Man."**
