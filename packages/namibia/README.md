# Namibia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Namibia. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `na-company-formation.md`
4. `na-corporate-income-tax.md`
5. `na-income-tax.md`
6. `na-payroll-social.md`
7. `na-tax-overview.md`
8. `na-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Namibia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Namibia."**
...
These Namibia tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
