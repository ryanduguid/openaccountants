# Guinea — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Guinea. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `gn-company-formation.md`
4. `gn-corporate-income-tax.md`
5. `gn-income-tax.md`
6. `gn-payroll-social.md`
7. `gn-tax-overview.md`
8. `gn-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Guinea taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Guinea."**
...
These Guinea tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
