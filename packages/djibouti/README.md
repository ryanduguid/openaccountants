# Djibouti — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Djibouti. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `dj-company-formation.md`
4. `dj-corporate-income-tax.md`
5. `dj-income-tax.md`
6. `dj-payroll-social.md`
7. `dj-tax-overview.md`
8. `dj-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Djibouti taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Djibouti."**
...
These Djibouti tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
