# Sudan — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Sudan. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `sd-company-formation.md`
4. `sd-corporate-income-tax.md`
5. `sd-income-tax.md`
6. `sd-payroll-social.md`
7. `sd-tax-overview.md`
8. `sd-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Sudan taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Sudan."**
...
These Sudan tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
