# Albania — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Albania. Upload to Claude, ChatGPT, or any AI assistant.
...
3. Tell the AI what you need:
   ...
   - **"Help me set up a company in Albania."**
