# Manitoba (MB) — AI Tax Assistant | OpenAccountants

> Open-source federal + Manitoba provincial/territorial tax skills for AI.
...
- Produce federal T1/T2125 AND Manitoba provincial working papers
...
## Are you a CPA or tax professional in Manitoba?

These Manitoba tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a Canadian CPA to verify it.
...
Or if you're comfortable with GitHub: fork the repo, fix the source under `skills/international/canada/manitoba/`, and submit a PR.
