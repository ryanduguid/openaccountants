# Central African Republic — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Central African Republic. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `cf-company-formation.md`
4. `cf-corporate-income-tax.md`
5. `cf-income-tax.md`
6. `cf-payroll-social.md`
7. `cf-tax-overview.md`
8. `cf-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Central African Republic taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Central African Republic."**
...
These Central African Republic tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
