# Tonga — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Tonga. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `to-company-formation.md`
4. `to-corporate-income-tax.md`
5. `to-income-tax.md`
6. `to-payroll-social.md`
7. `to-tax-overview.md`
8. `to-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Tonga taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Tonga."**
...
These Tonga tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
