# Spain — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Spain. Upload to Claude, ChatGPT, or any AI assistant.
...
4. `es-beckham.md`
5. `es-capital-gains.md`
6. `es-corporate-tax.md`
7. `es-estimated-tax.md`
8. `es-income-tax.md`
9. `es-irpf-deductions.md`
10. `es-modelo-111.md`
11. `es-rental-income.md`
12. `es-social-contributions.md`
13. `es-vat-return.md`
14. `references.md`
15. `spain-bookkeeping.md`
16. `spain-crypto-tax.md`
17. `spain-einvoice.md`
18. `spain-financial-statements.md`
19. `spain-formation.md`
20. `spain-payroll.md`
21. `spain-tax-optimization.md`
22. `spain-transfer-pricing.md`
23. `spain-vat-return.md`
24. `eu-vat-directive.md`
25. `bookkeeping-workflow-base.md`
26. `einvoice-workflow-base.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Spain taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Spain."**
...
**This is not tax, legal, or financial advice.** Everything produced must be reviewed and signed off by a qualified asesor fiscal before filing or acting upon.
