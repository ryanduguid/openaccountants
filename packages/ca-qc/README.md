# Quebec (QC) — AI Tax Assistant | OpenAccountants

> Open-source federal + Quebec provincial/territorial tax skills for AI.
...
**Quebec-specific** provincial/territorial tax skills. Upload all files together.
...
23. `qc-individual-return.md`
24. `qc-qst-return.md`
25. `ca-freelance-intake.md`
26. `ca-return-assembly.md`
27. `global-router.md`
...
3. Say: **"Help me with my 2025 taxes. I'm based in Quebec. Here's my bank statement."**

The AI will:
- Ask onboarding questions to confirm your situation
- Classify every transaction on your bank statement
- Produce federal T1/T2125 AND Quebec provincial working papers
...
## Are you a CPA or tax professional in Quebec?

These Quebec tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a Canadian CPA to verify it.
...
Or if you're comfortable with GitHub: fork the repo, fix the source under `skills/international/canada/quebec/`, and submit a PR.
