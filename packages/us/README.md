# United States — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for United States. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `us-capital-gains.md`
4. `us-nonresident-cgt.md`
5. `us-tax-residency.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 United States taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in United States."**
...
**This is not tax, legal, or financial advice.** Everything produced must be reviewed and signed off by a qualified CPA or EA before filing or acting upon.
...
These United States tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
