# Us — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Us. Upload to Claude, ChatGPT, or any AI assistant.
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Us taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Us."**
...
These Us tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
