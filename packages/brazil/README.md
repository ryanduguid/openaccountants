# Brazil — AI Tax Assistant | OpenAccountants

> Open-source tax computation skills for Brazil. Upload to Claude, ChatGPT, or any AI assistant.
...
contador, imposto de renda, IRPF, Simples Nacional, MEI, INSS, nota fiscal
...
3. Say: **"Help me with my 2025 Brazil taxes. Here's my bank statement."**
...
- Flag anything that needs your contador's attention

## Important

**This is not tax advice.** Everything produced must be reviewed and signed off by a qualified contador before filing.
...
These Brazil tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
