# Cuba — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Cuba. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `cu-company-formation.md`
4. `cu-corporate-income-tax.md`
5. `cu-income-tax.md`
6. `cu-payroll-social.md`
7. `cu-tax-overview.md`
8. `cu-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Cuba taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Cuba."**
...
These Cuba tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
