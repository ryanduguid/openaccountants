# Dr Congo — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Dr Congo. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `cd-company-formation.md`
4. `cd-corporate-income-tax.md`
5. `cd-income-tax.md`
6. `cd-payroll-social.md`
7. `cd-tax-overview.md`
8. `cd-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Dr Congo taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Dr Congo."**
...
These Dr Congo tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
