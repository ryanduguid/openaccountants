# Somalia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Somalia. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `so-company-formation.md`
4. `so-corporate-income-tax.md`
5. `so-income-tax.md`
6. `so-payroll-social.md`
7. `so-tax-overview.md`
8. `so-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Somalia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Somalia."**
...
These Somalia tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
