# Gabon — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Gabon. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `ga-company-formation.md`
4. `ga-corporate-income-tax.md`
5. `ga-payroll-social.md`
6. `ga-tax-overview.md`
7. `ga-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Gabon taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Gabon."**
...
These Gabon tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
