# Republic Of Congo — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Republic Of Congo. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `cg-company-formation.md`
4. `cg-corporate-income-tax.md`
5. `cg-income-tax.md`
6. `cg-payroll-social.md`
7. `cg-tax-overview.md`
8. `cg-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Republic Of Congo taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Republic Of Congo."**
...
These Republic Of Congo tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
