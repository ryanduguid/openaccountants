# United Arab Emirates — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for United Arab Emirates. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `ae-company-formation.md`
4. `ae-vat-return.md`
5. `company-formation-workflow-base.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 United Arab Emirates taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in United Arab Emirates."**
...
These United Arab Emirates tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
