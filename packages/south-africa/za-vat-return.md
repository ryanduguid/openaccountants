...
- **Skill version / contributor** — Editorial only. After this validation review the "Pending" status should be updated.
...
- **Changelog v2.0** — After this validation, version 2.1 changelog should record: corrected R2.3m registration threshold; corrected bank charges and payment processor fees to standard-rated; corrected VAT201 field structure; added motor car block; added s 18(3) fringe benefits; added tax invoice compliance requirements.
...
- **Never present calculations as definitive** — Always label as estimated; direct to SARS-registered tax practitioner
