# Intake — Onboarding for South Africa
...
> "I'll help you prepare your 2025 South Africa tax working papers. Everything I produce is for your SAIPA/SAICA member to review — I won't file anything. Let me ask a few questions to make sure I can help."
...
| # | Question |
|---|----------|
| 1 | Were you a full-year South Africa resident in 2025? |
...
| Trigger | Response |
|---------|----------|
| Not full-year resident | "I'm set up for full-year South Africa residents only. You need a SAIPA/SAICA member who handles non-resident returns." |
| Partnership | "Partnerships file separately. You need a SAIPA/SAICA member familiar with partnership returns." |
| Corporation (unless single-director/shareholder company) | "I don't cover corporate returns. You need a SAIPA/SAICA member." |
| Has employees | "Payroll and employer obligations are outside my scope. You need a SAIPA/SAICA member." |
...
After classification, present any decisions the user or their SAIPA/SAICA member needs to make:

> **Decisions for you / your SAIPA/SAICA member:**
...
*All outputs must be reviewed by a SAIPA/SAICA member before filing.*
