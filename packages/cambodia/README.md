# Cambodia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Cambodia. Upload to Claude, ChatGPT, or any AI assistant.
...
2. `intake.md`
3. `cambodia-vat.md`
4. `kh-company-formation.md`
5. `kh-corporate-income-tax.md`
6. `kh-income-tax.md`
7. `kh-payroll-social.md`
8. `kh-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Cambodia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Cambodia."**
