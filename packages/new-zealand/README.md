# New Zealand — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for New Zealand. Upload to Claude, ChatGPT, or any AI assistant.
...
3. Tell the AI what you need:
   ...
   - **"Help me set up a company in New Zealand."**
