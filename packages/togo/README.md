# Togo — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Togo. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `tg-company-formation.md`
4. `tg-corporate-income-tax.md`
5. `tg-income-tax.md`
6. `tg-payroll-social.md`
7. `tg-tax-overview.md`
8. `tg-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Togo taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Togo."**
...
These Togo tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
