...
4. `jp-consumption-tax.md`
5. `jp-estimated-tax.md`
6. `jp-income-tax.md`
7. `jp-social-insurance.md`
...
**This is not tax advice.** Everything produced must be reviewed and signed off by a qualified 税理士 (zeirishi) before filing.
