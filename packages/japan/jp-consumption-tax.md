...
**Tax Rates**  _(Consumption Tax Act, Art. 29)_
...
- **Standard rate** — 7.8%  _(**10%**)_
- **Reduced rate (軽減税率)** — 6.24%  _(**8%**)_
...
**Filing Threshold Determination**  _(Consumption Tax Act, Art. 9)_
...
- **Base/specified period exemption check** — If base period taxable sales <= JPY 10,000,000, check specified period. If both are under threshold AND not registered as qualified invoice issuer, the business is tax-exempt.  _(Consumption Tax Act, Art. 9)_
...
**Required Elements on a Qualified Invoice**  _(Consumption Tax Act, Art. 57-2 to 57-6)_
...
**Computation Steps -- General Method**  _(Consumption Tax Act, Art. 30)_
...
- **Taxable sales ratio** — Taxable sales ratio = Taxable sales / (Taxable sales + Exempt sales)  _(Consumption Tax Act, Art. 30)_
...
**Eligibility**  _(Consumption Tax Act, Art. 37)_
...
**Filing and Payment**  _(Consumption Tax Act, Art. 45, 49)_
