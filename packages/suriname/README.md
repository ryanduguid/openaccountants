# Suriname — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Suriname. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `sr-company-formation.md`
4. `sr-corporate-income-tax.md`
5. `sr-income-tax.md`
6. `sr-payroll-social.md`
7. `sr-tax-overview.md`
8. `sr-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Suriname taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Suriname."**
...
These Suriname tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
