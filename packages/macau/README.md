# Morocco — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Morocco. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `mo-company-formation.md`
4. `mo-corporate-income-tax.md`
5. `mo-payroll-social.md`
6. `mo-tax-overview.md`
7. `mo-vat-gst.md`
...
3. Tell the AI what you need:
   ...
   - **"Help me set up a company in Morocco."**
