# Iran — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Iran. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `ir-company-formation.md`
4. `ir-corporate-income-tax.md`
5. `ir-income-tax.md`
6. `ir-payroll-social.md`
7. `ir-tax-overview.md`
8. `iran-vat.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Iran taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Iran."**
