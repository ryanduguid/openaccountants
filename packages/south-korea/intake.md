...
> "I'll help you with your South Korea accounting and tax working papers. Everything I produce is for your 세무사 (semusa) to review — I won't file anything. Let me ask a few questions to make sure I can help."
...
| Partnership tax return | "Partnership tax returns file separately. You need a 세무사 (semusa) familiar with partnership returns." |
| Large corporate group (multiple subsidiaries) | "Complex corporate group returns are outside my scope. You need a 세무사 (semusa)." |
