# Greece — AI Tax Assistant | OpenAccountants

> Open-source tax computation skills for Greece. Upload to Claude, ChatGPT, or any AI assistant.
...
λογιστής, φόρος εισοδήματος, ΦΠΑ, ΕΦΚΑ, ελεύθερος επαγγελματίας

Tax authority: **AADE (Ανεξάρτητη Αρχή Δημοσίων Εσόδων)**
...
3. Say: **"Help me with my 2025 Greece taxes. Here's my bank statement."**
...
These Greece tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
