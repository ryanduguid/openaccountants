# Lesotho — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Lesotho. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `ls-company-formation.md`
4. `ls-corporate-income-tax.md`
5. `ls-income-tax.md`
6. `ls-payroll-social.md`
7. `ls-tax-overview.md`
8. `ls-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Lesotho taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Lesotho."**
...
These Lesotho tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
