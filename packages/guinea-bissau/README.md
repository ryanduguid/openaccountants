# Guinea Bissau — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Guinea Bissau. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `gw-company-formation.md`
4. `gw-corporate-income-tax.md`
5. `gw-income-tax.md`
6. `gw-payroll-social.md`
7. `gw-tax-overview.md`
8. `gw-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Guinea Bissau taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Guinea Bissau."**
...
These Guinea Bissau tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
