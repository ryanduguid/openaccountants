# Newfoundland and Labrador (NL) — AI Tax Assistant | OpenAccountants

> Open-source federal + Newfoundland and Labrador provincial/territorial tax skills for AI.
...
**Newfoundland and Labrador-specific** provincial/territorial tax skills. Upload all files together.
...
23. `nl-individual-return.md`
24. `ca-freelance-intake.md`
25. `ca-return-assembly.md`
26. `global-router.md`
...
3. Say: **"Help me with my 2025 taxes. I'm based in Newfoundland and Labrador. Here's my bank statement."**

The AI will:
- Ask onboarding questions to confirm your situation
- Classify every transaction on your bank statement
- Produce federal T1/T2125 AND Newfoundland and Labrador provincial working papers
...
## Are you a CPA or tax professional in Newfoundland and Labrador?

These Newfoundland and Labrador tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a Canadian CPA to verify it.
...
Or if you're comfortable with GitHub: fork the repo, fix the source under `skills/international/canada/newfoundland/`, and submit a PR.
