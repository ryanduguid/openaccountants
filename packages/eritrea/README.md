# Eritrea — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Eritrea. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `er-company-formation.md`
4. `er-corporate-income-tax.md`
5. `er-income-tax.md`
6. `er-payroll-social.md`
7. `er-tax-overview.md`
8. `er-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Eritrea taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Eritrea."**
...
These Eritrea tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
