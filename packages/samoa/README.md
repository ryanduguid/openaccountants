# Saudi Arabia — AI Accounting Assistant | OpenAccountants
...
1. `foundation.md`
2. `intake.md`
3. `ws-company-formation.md`
4. `ws-corporate-income-tax.md`
5. `ws-income-tax.md`
6. `ws-payroll-social.md`
7. `ws-tax-overview.md`
8. `ws-vat-gst.md`
...
3. Tell the AI what you need:
   ...
   - **"Help me set up a company in Saudi Arabia."**
