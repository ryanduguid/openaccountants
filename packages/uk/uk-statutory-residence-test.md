...
1. **Automatic Overseas Tests** (definitely NOT UK resident) — check first
2. **Automatic UK Tests** (definitely IS UK resident) — check second
3. **Sufficient Ties Test** (may be UK resident based on ties + days) — check if neither automatic test applies
...
- **Case 1**: Leaving UK to go overseas for full-time work
- **Case 2**: UK partner leaving with Case 1 individual
- **Case 3**: Leaving UK for another reason (must cease to have a UK home)
- **Case 4**: Arriving in UK to start full-time work
- **Case 5**: Arriving as partner of Case 4 individual
- **Case 6**: Arriving in UK having had no overseas home (becomes resident on taking up UK home)
- **Case 7**: Arriving in UK — start of UK residence (not covered by cases 4-6)
- **Case 8**: Ceasing full-time UK work (partner of Case 1)

In a split year, UK is only taxed on income/gains arising in the **UK part** of the year.

## Section 7 — Counting Days

- **Day in the UK** — any day you are present in the UK at midnight. However, a day is NOT counted if you are in transit (passing through without staying the night) and your journey is to/from an overseas destination.
...
- HMRC: gov.uk/guidance/statutory-residence-test-srt
