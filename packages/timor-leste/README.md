# Timor Leste — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Timor Leste. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `tl-company-formation.md`
4. `tl-corporate-income-tax.md`
5. `tl-income-tax.md`
6. `tl-payroll-social.md`
7. `tl-tax-overview.md`
8. `tl-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Timor Leste taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Timor Leste."**
...
These Timor Leste tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
