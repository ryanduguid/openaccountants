...
**Normiranec (standardised-expense) Regime**
...
- **2026 change** — normiranci move to a **progressive scale**; revenue above €120,000 is taxed at **35%**. **[RESEARCH GAP — reviewer to confirm the 2026 progressive brackets and whether the flat treatment is fully replaced.]**  _([RESEARCH GAP — reviewer to confirm the 2026 progressive brackets and whether the flat treatment is fully replaced.])_
...
- **No combining regimes** — NEVER combine the 80% standardised expenses with real-expense deductions — it is one or the other.
- **No under-reporting advice** — NEVER advise under-reporting revenue to remain a normiranec.
- **No disguised employment presentation** — NEVER present a single-client s.p. as genuine self-employment.
- **No contradiction of related skills** — NEVER contradict the rates in `slovenia-income-tax.md` / `slovenia-social-contributions.md`.
- **No presenting research gaps as confirmed** — NEVER present [RESEARCH GAP] figures as confirmed, nor optimisation as definitive advice — route to a licensed Slovenian tax adviser.
