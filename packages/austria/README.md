# Austria — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Austria. Upload to Claude, ChatGPT, or any AI assistant.
...
Steuerberater, Einkommensteuer, Umsatzsteuer, SVS, EPU

Tax authority: **Bundesministerium für Finanzen / FinanzOnline**
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Austria taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Austria."**
...
These Austria tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
