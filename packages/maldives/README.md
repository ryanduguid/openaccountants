# Maldives — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Maldives. Upload to Claude, ChatGPT, or any AI assistant.
...
2. `intake.md`
3. `maldives-gst.md`
4. `mv-company-formation.md`
5. `mv-corporate-income-tax.md`
6. `mv-income-tax.md`
7. `mv-payroll-social.md`
8. `mv-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Maldives taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Maldives."**
