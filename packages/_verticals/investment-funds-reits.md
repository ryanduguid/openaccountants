...
| **United Kingdom** | **Two regimes, one year apart.** From **6 April 2025** carried interest is charged to capital gains tax at a single **32%** rate (up from 28%, and from 18% for a basic-rate taxpayer) — enacted, not proposed. From **6 April 2026** it leaves CGT altogether and is taxed as the profits of a deemed trade, subject to income tax **and Class 4 NICs**, with only **72.5%** of qualifying carried interest brought into charge — an effective rate of about **34.1%** at the 45% additional rate plus 2% Class 4. Carry that is income-based carried interest does not qualify for the 72.5% multiplier. Disguised Investment Management Fees (DIMF) since 2015 | 32% (2025-26); ~34.1% effective (2026-27 onward) |
