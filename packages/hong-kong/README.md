# Hong Kong — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Hong Kong. Upload to Claude, ChatGPT, or any AI assistant.
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Hong Kong taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Hong Kong."**
