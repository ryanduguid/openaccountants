# Iraq — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Iraq. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `iq-company-formation.md`
4. `iq-corporate-income-tax.md`
5. `iq-income-tax.md`
6. `iq-payroll-social.md`
7. `iq-tax-overview.md`
8. `iq-vat-gst.md`
9. `iraq-tax.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Iraq taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Iraq."**
