# Myanmar — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Myanmar. Upload to Claude, ChatGPT, or any AI assistant.
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Myanmar taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Myanmar."**
...
These Myanmar tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
