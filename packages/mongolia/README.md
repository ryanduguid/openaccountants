# Mongolia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Mongolia. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `mn-company-formation.md`
4. `mn-corporate-income-tax.md`
5. `mn-payroll-social.md`
6. `mn-tax-overview.md`
7. `mongolia-vat.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Mongolia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Mongolia."**
