...
| Business tax credit -- full | Tax of $3,400 or less: credit equals the entire tax | NYC Admin Code §11-503(b)(A) |
...
| Filing threshold | Gross income over $95,000, or any UBT liability | NYC-202 instructions |
...
FILING threshold. Two separate reliefs apply: a **$5,000 specific exemption** (§11-510)
subtracted before the 4% rate, then a **business tax credit** (§11-503(b)) applied
...
= $4,200, so credit = $4,200 x ($5,400 - $4,200) / $2,000 = $2,520 and UBT payable
= $1,680.
