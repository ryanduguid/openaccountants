# Afghanistan — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Afghanistan. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `af-company-formation.md`
4. `af-corporate-income-tax.md`
5. `af-income-tax.md`
6. `af-payroll-social.md`
7. `af-tax-overview.md`
8. `af-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Afghanistan taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Afghanistan."**
...
These Afghanistan tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
