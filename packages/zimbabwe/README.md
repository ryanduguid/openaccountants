# Zimbabwe — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Zimbabwe. Upload to Claude, ChatGPT, or any AI assistant.
...
2. `intake.md`
3. `zimbabwe-vat.md`
4. `zw-company-formation.md`
5. `zw-corporate-income-tax.md`
6. `zw-income-tax.md`
7. `zw-payroll-social.md`
8. `zw-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Zimbabwe taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Zimbabwe."**
