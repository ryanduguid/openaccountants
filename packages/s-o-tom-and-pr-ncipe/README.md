# S O Tom And Pr Ncipe — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for S O Tom And Pr Ncipe. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `st-company-formation.md`
4. `st-corporate-income-tax.md`
5. `st-income-tax.md`
6. `st-payroll-social.md`
7. `st-tax-overview.md`
8. `st-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 S O Tom And Pr Ncipe taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in S O Tom And Pr Ncipe."**
...
These S O Tom And Pr Ncipe tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
