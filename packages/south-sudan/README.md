# South Sudan — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for South Sudan. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `ss-company-formation.md`
4. `ss-corporate-income-tax.md`
5. `ss-income-tax.md`
6. `ss-payroll-social.md`
7. `ss-tax-overview.md`
8. `ss-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 South Sudan taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in South Sudan."**
...
These South Sudan tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
