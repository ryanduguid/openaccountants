# Guyana — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Guyana. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `gy-company-formation.md`
4. `gy-corporate-income-tax.md`
5. `gy-income-tax.md`
6. `gy-payroll-social.md`
7. `gy-tax-overview.md`
8. `gy-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Guyana taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Guyana."**
...
These Guyana tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
