# Lithuania — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Lithuania. Upload to Claude, ChatGPT, or any AI assistant.
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Lithuania taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Lithuania."**
