# Jordan — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Jordan. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `jo-company-formation.md`
4. `jo-corporate-income-tax.md`
5. `jo-income-tax.md`
6. `jo-payroll-social.md`
7. `jo-tax-overview.md`
8. `jordan-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Jordan taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Jordan."**
