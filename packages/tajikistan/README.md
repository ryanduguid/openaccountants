# Tajikistan — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Tajikistan. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `tj-company-formation.md`
4. `tj-corporate-income-tax.md`
5. `tj-income-tax.md`
6. `tj-payroll-social.md`
7. `tj-tax-overview.md`
8. `tj-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Tajikistan taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Tajikistan."**
...
These Tajikistan tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
