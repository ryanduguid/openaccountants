# Portugal — AI Accounting Assistant | OpenAccountants
...
4. `portugal-crypto-tax.md`
5. `portugal-einvoice.md`
6. `portugal-financial-statements.md`
7. `portugal-formation.md`
...
contabilista certificado, IRS, IVA, recibos verdes, trabalhador independente
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Portugal taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Portugal."**
...
- Flag anything that needs your contabilista certificado's attention

## Important

**This is not tax, legal, or financial advice.** Everything produced must be reviewed and signed off by a qualified contabilista certificado before filing or acting upon.

The most up-to-date, verified version of these skills is maintained at [openaccountants.com](https://openaccountants.com).

---

## Are you a contabilista certificado?

These Portugal tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
