...
A versão mais atualizada e verificada desta skill é mantida em [openaccountants.com](https://www.openaccountants.com). Inicie sessão para aceder à versão mais recente, solicitar revisão profissional por contabilista licenciado e acompanhar atualizações à medida que a legislação fiscal evolui.
