# Vanuatu — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Vanuatu. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `vu-company-formation.md`
4. `vu-corporate-income-tax.md`
5. `vu-income-tax.md`
6. `vu-payroll-social.md`
7. `vu-tax-overview.md`
8. `vu-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Vanuatu taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Vanuatu."**
...
These Vanuatu tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
