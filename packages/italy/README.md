# Italy — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Italy. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `it-estimated-tax.md`
4. `it-impatriati.md`
5. `it-income-tax.md`
6. `it-inps-contributions.md`
7. `it-irap.md`
8. `italy-bookkeeping.md`
9. `italy-crypto-tax.md`
10. `italy-einvoice.md`
11. `italy-financial-statements.md`
12. `italy-formation.md`
13. `italy-payroll.md`
14. `italy-tax-optimization.md`
15. `italy-transfer-pricing.md`
16. `italy-vat-return.md`
17. `references.md`
...
commercialista, IRPEF, IVA, regime forfettario, partita IVA, INPS, F24
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Italy taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Italy."**
...
- Flag anything that needs your commercialista's attention

## Important

**This is not tax, legal, or financial advice.** Everything produced must be reviewed and signed off by a qualified commercialista before filing or acting upon.

The most up-to-date, verified version of these skills is maintained at [openaccountants.com](https://www.openaccountants.com).

---

## Are you a commercialista?

These Italy tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
