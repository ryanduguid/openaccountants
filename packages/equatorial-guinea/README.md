# Equatorial Guinea — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Equatorial Guinea. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `gq-company-formation.md`
4. `gq-corporate-income-tax.md`
5. `gq-income-tax.md`
6. `gq-payroll-social.md`
7. `gq-tax-overview.md`
8. `gq-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Equatorial Guinea taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Equatorial Guinea."**
...
These Equatorial Guinea tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
