# Burkina Faso — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Burkina Faso. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `bf-company-formation.md`
4. `bf-corporate-tax.md`
5. `bf-income-tax.md`
6. `bf-payroll.md`
7. `bf-social-contributions.md`
8. `bf-tax-optimization.md`
9. `bf-tax-overview.md`
10. `bf-vat.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Burkina Faso taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Burkina Faso."**
...
These Burkina Faso tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
