# Gambia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Gambia. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `gm-company-formation.md`
4. `gm-corporate-income-tax.md`
5. `gm-income-tax.md`
6. `gm-payroll-social.md`
7. `gm-tax-overview.md`
8. `gm-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Gambia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Gambia."**
...
These Gambia tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
