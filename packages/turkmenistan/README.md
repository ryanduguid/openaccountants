# Turkmenistan — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Turkmenistan. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `tm-company-formation.md`
4. `tm-corporate-income-tax.md`
5. `tm-income-tax.md`
6. `tm-payroll-social.md`
7. `tm-tax-overview.md`
8. `tm-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Turkmenistan taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Turkmenistan."**
...
These Turkmenistan tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
