# Angola — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Angola. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `ao-company-formation.md`
4. `ao-corporate-income-tax.md`
5. `ao-income-tax.md`
6. `ao-payroll-social.md`
7. `ao-tax-overview.md`
8. `ao-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Angola taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Angola."**
...
These Angola tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
