# Bolivia — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Bolivia. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `bw-company-formation.md`
4. `bw-corporate-income-tax.md`
5. `bw-income-tax.md`
6. `bw-payroll-social.md`
7. `bw-tax-overview.md`
8. `bw-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Bolivia taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Bolivia."**
