# Yukon (YT) — AI Tax Assistant | OpenAccountants

> Open-source federal + Yukon provincial/territorial tax skills for AI.
...
**Yukon-specific** provincial/territorial tax skills. Upload all files together.
...
3. Say: **"Help me with my 2025 taxes. I'm based in Yukon. Here's my bank statement."**

The AI will:
- Ask onboarding questions to confirm your situation
- Classify every transaction on your bank statement
- Produce federal T1/T2125 AND Yukon provincial working papers
...
## Are you a CPA or tax professional in Yukon?

These Yukon tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a Canadian CPA to verify it.
...
Or if you're comfortable with GitHub: fork the repo, fix the source under `skills/international/canada/yukon/`, and submit a PR.
