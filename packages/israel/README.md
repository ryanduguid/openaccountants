# Israel — AI Tax Assistant | OpenAccountants

> Open-source tax computation skills for Israel. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `il-corporate-tax.md`
4. `il-crypto-tax.md`
5. `il-customs-duty.md`
...
רואה חשבון (ro'e cheshbon), מס הכנסה, מע"מ, עוסק מורשה, ביטוח לאומי

Tax authority: **Israel Tax Authority (רשות המסים)**
