# Bahamas — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Bahamas. Upload to Claude, ChatGPT, or any AI assistant.
...
2. `intake.md`
3. `bahamas-vat.md`
4. `bs-company-formation.md`
5. `bs-corporate-income-tax.md`
6. `bs-income-tax.md`
7. `bs-payroll-social.md`
8. `bs-tax-overview.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Bahamas taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Bahamas."**
