...
- **R-IL-1** — Home rule municipal taxes. Each home rule municipality has unique ordinances. Escalate to reviewer for specific compliance.  _(R-IL-1)_
- **R-IL-2** — Chicago amusement tax on streaming. 9% separate municipal tax. Outside scope for filing.  _(R-IL-2)_
...
- **Candy vs food flour test** — Items containing flour = FOOD (1%). Items without flour but with sugar/sweetener as primary = CANDY (6.25%).  _(unsure)_
...
- **Record retention** — 4 years from filing or due date.  _(unsure)_
