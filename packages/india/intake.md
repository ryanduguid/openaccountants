...
> "I'll help you with your India accounting and tax working papers. Everything I produce is for your Chartered Accountant (CA) to review — I won't file anything. Let me ask a few questions to make sure I can help."
...
| Partnership tax return | "Partnership tax returns file separately. You need a Chartered Accountant (CA) familiar with partnership returns." |
| Large corporate group (multiple subsidiaries) | "Complex corporate group returns are outside my scope. You need a Chartered Accountant (CA)." |
