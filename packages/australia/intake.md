# Intake — Onboarding for Australia
...
> "I'll help you prepare your 2025 Australia tax working papers. Everything I produce is for your registered tax agent to review — I won't file anything. Let me ask a few questions to make sure I can help."
...
| # | Question |
|---|----------|
| 1 | Were you a full-year Australia resident in 2025? |
...
| Trigger | Response |
|---------|----------|
| Not full-year resident | "I'm set up for full-year Australia residents only. You need a registered tax agent who handles non-resident returns." |
| Partnership | "Partnerships file separately. You need a registered tax agent familiar with partnership returns." |
| Corporation (unless single-director/shareholder company) | "I don't cover corporate returns. You need a registered tax agent." |
| Has employees | "Payroll and employer obligations are outside my scope. You need a registered tax agent." |
...
After classification, present any decisions the user or their registered tax agent needs to make:

> **Decisions for you / your registered tax agent:**
...
*All outputs must be reviewed by a registered tax agent before filing.*
