# Burundi — AI Accounting Assistant | OpenAccountants

> Open-source accounting skills for Burundi. Upload to Claude, ChatGPT, or any AI assistant.
...
1. `foundation.md`
2. `intake.md`
3. `bi-company-formation.md`
4. `bi-corporate-income-tax.md`
5. `bi-income-tax.md`
6. `bi-payroll-social.md`
7. `bi-tax-overview.md`
8. `bi-vat-gst.md`
...
3. Tell the AI what you need:
   - **"Help me with my 2025 Burundi taxes. Here's my bank statement."**
   - **"Classify my transactions and prepare my books."**
   - **"Run payroll for my employee."**
   - **"Help me set up a company in Burundi."**
...
These Burundi tax skills need your eye. Every rate, threshold, and form reference was AI-drafted and needs a human professional to verify it.
