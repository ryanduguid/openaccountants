...
- **Minimum viable inputs** — Confirmation of Ohio nexus (physical or economic), vendor license status, filing frequency, and list of products/services sold.
- **Recommended inputs** — Sales by county, exemption certificates on file, prior period UST-1.
- **Ideal inputs** — Complete transaction log with ship-to addresses, exemption certificate register, CAT filing status.
...
- **State rate** — 5.75%
- **County permissive taxes range** — 0.75% to 2.25%
- **No city/district tax** — No city or special district taxes.

### 5.2 Sourcing (ORC 5739.033)

- **Sourcing basis** — Origin-based for intrastate (both seller and buyer in Ohio). Destination-based for remote sellers (SST compliant).  _(ORC 5739.033)_

### 5.3 Filing (ORC 5739.12)

**Filing frequency and due dates**  _(ORC 5739.12)_
...
- **Vendor discount rate** — 0.75% of tax collected for timely filing and payment. No cap.  _(ORC 5739.12(B))_
...
- **Use tax applicability** — Applies when Ohio purchaser acquires TPP/services without Ohio tax collected. Rate = combined state + county at location of use. Report on UST-1 (vendors) or IT-1040 (individuals).
...
- **Data processing vs consulting** — Cloud analytics may be taxable as automatic data processing. However, consulting services using technology incidentally may not qualify. Flag for reviewer.

### 6.2 CAT Interaction

- **CAT interaction** — Ohio imposes BOTH sales tax (customer-collected) and CAT (seller's gross receipts). They are separate. Escalate CAT questions.

### 6.3 Complex Bundled Transactions

- **Complex bundled transactions** — When taxable and exempt items are sold together, bundling rules determine treatment. Flag for reviewer.
