...
| **A Canadian sole proprietor** | [`packages/ca-<province>/`](packages/) (e.g. `ca-on`, `ca-qc`, `ca-bc`) | All files in your province folder | "Help me with my 2025 taxes. I'm based in [province]. Here's my bank statement." |
...
| **A crypto trader / investor** | Your country package + [`packages/<country>/<country>-crypto-tax.md`](packages/) (22 countries have a dedicated skill) | Country + crypto skill | "Here's my exchange CSV / wallet history. Help me with my crypto tax." |
